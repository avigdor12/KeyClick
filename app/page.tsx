...
function GuidesDetailPage({ lang, category, drawerLabel, contentTitle, contentDesc, pageId, navButtons, onNavigate }: { lang: typeof languages[0]; category: string; drawerLabel: string; contentTitle: string; contentDesc: string; pageId?: string; navButtons?: { label: string; page: string }[]; onNavigate?: (page: string) => void }) {
  ...
  return (
    <div className="guides-page" dir="rtl" style={{ gap: 10, paddingBottom: 24 }}>
      ...
      <div className="furniture" style={{ flex: 1, width: '100%', minHeight: 0 }}>
        ...
        <div className="cabinet" style={{ width: cabinetWidth, flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
          <div className="tray-card" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
            <div className="tray-row"><strong>{contentTitle}</strong></div>
            <p className="tray-desc" style={{ maxWidth: 'none', flex: 1 }}>{contentDesc}</p>
          </div>
        </div>
