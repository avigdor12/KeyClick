...
const FINANCE_GUIDE_SECTIONS: Record<string, GuideSection[]> = {
  he: [
    ...
    { heading: 'לוח הבקרה', body: 'מבט ימינה מביא אותנו ללוח בקרה של האתר. לוח הבקרה מצד ימין תמיד גלוי בפניך,\n\nכל אחד מהפריטים על לוח הבקרה נועד למלא פונקציה של הצגה מקומית או מעבר לדף אחר. בהמשך במסמך זה יפורטו כל הפריטים הללו.', image: { src: '/guides/mfinance-control-panel.png', width: 131, height: 811 } },
