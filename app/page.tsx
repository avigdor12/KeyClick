...
export const languages = [
  { code: 'en', flag: 'בריטניה', name: 'English',  welcome: 'Welcome',
    ...
    profile: { fullName: 'Full Name', email: 'Email', ip: 'IP', language: 'Language', country: 'Country', notifSound: 'Notification sound', notifSoundOff: 'Off', notifSoundTest: 'Play', notifSoundUpload: 'Upload file...', notifSoundHint: 'Volume is controlled by the Windows mixer. The file is stored in this browser only.', notifSoundTooBig: 'File too large (max 900KB)', plan: 'Plan', planStart: 'Plan Start', planEnd: 'Plan End', unlimited: 'Unlimited', comingSoon: 'Coming Soon', choosePlan: 'Choose Plan', close: '✕ Close', loginRequired: 'Login required to view personal page', login: 'Login', products: 'Products', change: 'Change',
  ...
  { code: 'ru', flag: 'רוסיה',   name: 'Русский',  welcome: 'Добро пожаловать',
    ...
    profile: { fullName: 'Полное имя', email: 'Email', ip: 'IP', language: 'Язык', country: 'Страна', notifSound: 'Звук уведомления', notifSoundOff: 'Выкл.', notifSoundTest: 'Проиграть', notifSoundUpload: 'Загрузить файл...', notifSoundHint: 'Громкость управляется микшером Windows. Файл хранится только в этом браузере.', notifSoundTooBig: 'Файл слишком большой (макс. 900 КБ)', plan: 'Тариф', planStart: 'Начало тарифа', planEnd: 'Конец тарифа', unlimited: 'Без ограничений', comingSoon: 'Скоро', choosePlan: 'Выбрать тариф', close: '✕ Закрыть', loginRequired: 'Необходимо войти для просмотра', login: 'Войти', products: 'Продукты', change: 'Изменить',
  ...
  { code: 'de', flag: 'גרמניה',  name: 'Deutsch',  welcome: 'Willkommen',
    ...
    profile: { fullName: 'Vollständiger Name', email: 'E-Mail', ip: 'IP', language: 'Sprache', country: 'Land', notifSound: 'Benachrichtigungston', notifSoundOff: 'Aus', notifSoundTest: 'Abspielen', notifSoundUpload: 'Datei hochladen...', notifSoundHint: 'Die Lautstärke wird über den Windows-Mixer gesteuert. Die Datei wird nur in diesem Browser gespeichert.', notifSoundTooBig: 'Datei zu groß (max. 900 KB)', plan: 'Tarif', planStart: 'Tarif Beginn', planEnd: 'Tarif Ende', unlimited: 'Unbegrenzt', comingSoon: 'Demnächst', choosePlan: 'Tarif wählen', close: '✕ Schließen', loginRequired: 'Anmeldung erforderlich', login: 'Anmelden', products: 'Produkte', change: 'Ändern',
  ...
  { code: 'fr', flag: 'צרפת',    name: 'Français', welcome: 'Bienvenue',
    ...
    profile: { fullName: 'Nom complet', email: 'E-mail', ip: 'IP', language: 'Langue', country: 'Pays', notifSound: 'Son de notification', notifSoundOff: 'Désactivé', notifSoundTest: 'Écouter', notifSoundUpload: 'Téléverser un fichier...', notifSoundHint: "Le volume est contrôlé par le mixeur Windows. Le fichier est stocké uniquement dans ce navigateur.", notifSoundTooBig: 'Fichier trop volumineux (900 Ko max)', plan: 'Abonnement', planStart: 'Début', planEnd: 'Fin', unlimited: 'Illimité', comingSoon: 'Bientôt', choosePlan: 'Choisir un abonnement', close: '✕ Fermer', loginRequired: 'Connexion requise', login: 'Se connecter', products: 'Produits', change: 'Modifier',
  ...
  { code: 'he', flag: 'ישראל',   name: 'עברית',    welcome: 'ברוכים הבאים',
    ...
    card: { title: 'ניהול תקציב בית', namePh: 'שם / שם משפחה', emailPh: 'Email / כתובת מייל', passPh: 'סיסמא', confirmPassPh: 'אימות סיסמא', register: 'הרשמה', login: 'כניסה', locked: 'נעול', registered: 'רשום', update: 'עדכון', line1: 'בתקופת ההרצה', line2: 'חינם', errName: 'נא להזין שם', errEmail: 'נא להזין כתובת מייל תקינה', errPassLen: 'סיסמה חייבת להכיל לפחות 6 תווים', errPassMatch: 'נא להקליד אימות סיסמה מתאים', errEmailExists: 'אימייל כבר קיים במערכת', cancel: 'בטל', install: 'התקנה', library: 'קובצי הדרכה', run: 'הפעלה', videos: 'סרטונים', guide: 'הדרכה', ok: 'לחץ', msgAlreadyInstalled: 'כבר מותקן\nאין צורך בהתקנה', msgDownloading: 'נא להוריד קובץ התקנה', msgInstallComplete: 'נא לשמור ולהפעיל את הקובץ\nלהשלמת ההתקנה', msgDownloadError: 'שגיאה בהורדה\nנא לנסות שוב', mFinance: 'M Finance', msgExists: 'המשתמש עם הפרטים שהוקשו\nכבר רשום במערכת', msgUpdated: 'הפרטים עודכנו בהצלחה', msgRegistered: 'הרשמה הושלמה', existingCustomer: 'לקוח קיים', newCustomer: 'לקוח חדש', notRecognized: 'לקוח לא רשום. נא ללחוץ להרשמה', msgSelectPlan: 'נא לבחור תכנית בדף האישי', infoServices: 'שרותי מידע', guidesAndVideos: 'מדריכים וסרטונים', siteHeaderPrefix: 'אתר האינטרנט של', theWebsite: 'האתר', loginSubtitle: 'כניסה לחשבון', emailPhSimple: 'אימייל', passPhSimple: 'סיסמה', connectingEllipsis: 'מתחבר...', noAccountQuestion: 'אין לך חשבון?', registerHereLink: 'נא להירשם כאן', invalidCredentials: 'אימייל או סיסמה שגויים', registerErrorGeneric: 'שגיאה בהרשמה' },
    profile: { fullName: 'שם ומשפחה', email: 'דוא"ל', ip: 'IP', language: 'שפה', country: 'מדינה', notifSound: 'צליל התראה', notifSoundOff: 'ללא', notifSoundTest: 'נגן', notifSoundUpload: 'העלה קובץ...', notifSoundHint: 'העוצמה נשלטת ממיקסר Windows. הקובץ נשמר בדפדפן זה בלבד.', notifSoundTooBig: 'הקובץ גדול מדי (עד 900KB)', plan: 'תכנית', planStart: 'תחילת תכנית', planEnd: 'סיום תכנית', unlimited: 'ללא הגבלה', comingSoon: 'בקרוב', choosePlan: 'נא לבחור תכנית', close: '✕ סגור', loginRequired: 'נדרשת כניסה לצפייה בדף האישי', login: 'כניסה', products: 'מוצרים', change: 'שינוי',
      price: 'מחיר', changePlan: 'נא לבחור תכנית', planName: 'שם', planFrom: 'מ-', planTo: 'עד-', back: 'חזרה', currencyLocal: '₪', free: 'חינם',       planNames: { System_Free_Run: 'תקופת הרצה', User_Trial: 'תקופת נסיון', User_VIP_Free: 'VIP', System_Owner: 'מערכת', User_Monthly: 'חודשי', User_Annual: 'שנתי', User_One_Time: 'כניסה בודדת', System_Suspended_NonPayment: 'מנותק', User_Cancelled: 'בוטל' } },
  ...
  { code: 'es', flag: 'ספרד',    name: 'Español',  welcome: 'Bienvenidos',
    ...
    profile: { fullName: 'Nombre completo', email: 'Correo', ip: 'IP', language: 'Idioma', country: 'País', notifSound: 'Sonido de notificación', notifSoundOff: 'Desactivado', notifSoundTest: 'Reproducir', notifSoundUpload: 'Subir archivo...', notifSoundHint: 'El volumen se controla desde el mezclador de Windows. El archivo se guarda solo en este navegador.', notifSoundTooBig: 'Archivo demasiado grande (máx. 900 KB)', plan: 'Plan', planStart: 'Inicio del plan', planEnd: 'Fin del plan', unlimited: 'Sin límite', comingSoon: 'Próximamente', choosePlan: 'Elegir plan', close: '✕ Cerrar', loginRequired: 'Se requiere inicio de sesión', login: 'Iniciar sesión', products: 'Productos', change: 'Cambiar',
  ...
  { code: 'ja', flag: 'יפן',     name: '日本語',    welcome: 'ようこそ',
    ...
    profile: { fullName: 'フルネーム', email: 'メール', ip: 'IP', language: '言語', country: '国', notifSound: '通知音', notifSoundOff: 'オフ', notifSoundTest: '再生', notifSoundUpload: 'ファイルをアップロード...', notifSoundHint: '音量は Windows ミキサーで調整します。ファイルはこのブラウザーにのみ保存されます。', notifSoundTooBig: 'ファイルが大きすぎます（最大900KB）', plan: 'プラン', planStart: 'プラン開始', planEnd: 'プラン終了', unlimited: '無制限', comingSoon: '近日公開', choosePlan: 'プランを選択', close: '✕ 閉じる', loginRequired: 'ログインが必要です', login: 'ログイン', products: '製品', change: '変更',
  ...
  { code: 'zh', flag: 'סין',     name: '中文',      welcome: '欢迎',
    ...
    profile: { fullName: '全名', email: '邮箱', ip: 'IP', language: '语言', country: '国家', notifSound: '通知声音', notifSoundOff: '关闭', notifSoundTest: '播放', notifSoundUpload: '上传文件...', notifSoundHint: '音量由 Windows 混音器控制。文件仅保存在此浏览器中。', notifSoundTooBig: '文件过大（最大 900KB）', plan: '套餐', planStart: '套餐开始', planEnd: '套餐结束', unlimited: '无限制', comingSoon: '即将推出', choosePlan: '选择套餐', close: '✕ 关闭', loginRequired: '需要登录', login: '登录', products: '产品', change: '更改',
  ...
  { code: 'it', flag: 'איטליה',  name: 'Italiano', welcome: 'Benvenuti',
    ...
    profile: { fullName: 'Nome completo', email: 'Email', ip: 'IP', language: 'Lingua', country: 'Paese', notifSound: 'Suono di notifica', notifSoundOff: 'Disattivato', notifSoundTest: 'Riproduci', notifSoundUpload: 'Carica file...', notifSoundHint: 'Il volume è controllato dal mixer di Windows. Il file è salvato solo in questo browser.', notifSoundTooBig: 'File troppo grande (max 900 KB)', plan: 'Piano', planStart: 'Inizio piano', planEnd: 'Fine piano', unlimited: 'Illimitato', comingSoon: 'Prossimamente', choosePlan: 'Scegli piano', close: '✕ Chiudi', loginRequired: 'Accesso richiesto', login: 'Accedi', products: 'Prodotti', change: 'Modifica',
  ...
  { code: 'hi', flag: 'הודו',    name: 'हिंदी',     welcome: 'स्वागत है',
    ...
    profile: { fullName: 'पूरा नाम', email: 'ईमेल', ip: 'IP', language: 'भाषा', country: 'देश', notifSound: 'सूचना ध्वनि', notifSoundOff: 'बंद', notifSoundTest: 'चलाएं', notifSoundUpload: 'फ़ाइल अपलोड करें...', notifSoundHint: 'वॉल्यूम Windows मिक्सर से नियंत्रित होता है। फ़ाइल केवल इस ब्राउज़र में सहेजी जाती है।', notifSoundTooBig: 'फ़ाइल बहुत बड़ी है (अधिकतम 900KB)', plan: 'योजना', planStart: 'योजना शुरू', planEnd: 'योजना समाप्त', unlimited: 'असीमित', comingSoon: 'जल्द आ रहा है', choosePlan: 'योजना चुनें', close: '✕ बंद करें', loginRequired: 'लॉगिन आवश्यक है', login: 'लॉग इन', products: 'उत्पाद', change: 'बदलें',
...
// ===== צליל התראה להודעה חדשה =====
// localStorage['kc_notif_sound'] = 'ding'|'chime'|'beep'|'knock'|'off'|'custom'
// localStorage['kc_notif_custom'] = data-URI של קובץ שמע שהמשתמש העלה (מצב 'custom')
// עוצמה/השתקה בשליטת מיקסר Windows כמו כל אודיו בדפדפן.
const NOTIF_SOUND_KEYS = ['ding', 'chime', 'beep', 'knock', 'custom', 'off'] as const
function playNotifSound(override?: string, customOverride?: string) {
  try {
    const ls = typeof localStorage !== 'undefined' ? localStorage : null
    const which = override ?? ls?.getItem('kc_notif_sound') ?? 'ding'
    if (which === 'off') return
    if (which === 'custom') {
      const uri = customOverride ?? ls?.getItem('kc_notif_custom') ?? ''
      if (uri) { const a = new Audio(uri); a.volume = 1; a.play().catch(() => {}); return }
    }
    const AC = window.AudioContext || (window as unknown as { webkitAudioContext?: typeof AudioContext }).webkitAudioContext
    if (!AC) return
    const ctx = new AC()
    const t0 = ctx.currentTime
    const tone = (freq: number, start: number, dur: number, vol = 0.25, type: OscillatorType = 'sine') => {
    ...
    const k = which === 'custom' ? 'ding' : which
    if (k === 'chime') { tone(659, 0, 0.4); tone(880, 0.13, 0.4); tone(1175, 0.27, 0.6) }
    else if (k === 'beep') { tone(1000, 0, 0.16, 0.3, 'square') }
    else if (k === 'knock') { tone(190, 0, 0.11, 0.35, 'triangle'); tone(160, 0.17, 0.13, 0.35, 'triangle') }
    else { tone(880, 0, 0.5); tone(1320, 0.06, 0.5) }
    setTimeout(() => { ctx.close().catch(() => {}) }, 2000)
  } catch { /* audio blocked / unsupported */ }
}
  ...
  useEffect(() => {
    ...
    const checkUnread = () => {
      fetch(`/api/feedback/unread?userId=${Current_User_Pointer_to_DB.id}`)
        .then(r => r.json())
        .then(d => { if (d.hasUnread) setHasUnreadMsg(prev => { if (!prev) playNotifSound(); return true }) })
        .catch(() => {})
    }
    checkUnread()
  ...
  useEffect(() => {
    ...
    const checkAdminUnread = () => {
      fetch('/api/feedback/admin-unread')
        .then(r => r.json())
        .then(d => { if (d.hasUnread) setHasNewCustomerMsg(prev => { if (!prev) playNotifSound(); return true }) })
        .catch(() => {})
    }
    checkAdminUnread()
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', fontFamily: 'Arial, sans-serif', overflow: 'hidden', position: 'relative' }}>
      ...
      <header style={{ background: '#111', padding: '5px 14px', display: 'flex', gap: '6px', alignItems: 'center', flexShrink: 0 }}>
        ...
        {/* שם המשתמש המחובר - בקצה השורה, מעל פאנל הבקרה (רוחב 140 כמו הפאנל) */}
        <div style={{ width: '140px', flexShrink: 0, marginLeft: hasUnreadMsg ? '8px' : 'auto', marginRight: '-14px', textAlign: 'center' }}>
          {isLoggedInExplicit && Current_User_Pointer_to_DB?.name && (
            <span dir="auto" style={{ color: '#fff', fontSize: '16px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', display: 'inline-block', maxWidth: '100%', verticalAlign: 'middle' }}>{Current_User_Pointer_to_DB.name}</span>
          )}
        </div>
      </header>
        ...
        <div ref={sidebarContentRef} style={{ width: '100%', minHeight: sidebarAvailable, transform: `scale(${sidebarScale})`, transformOrigin: 'top center', position: 'absolute', top: 0, left: 0, display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="mf-luxury-btn" style={{ position: 'relative', display: 'block', margin: '16px auto 6px', width: '120px', background: 'linear-gradient(to bottom, #0d0d2b, #001a4a)', border: '2px solid #FFD700', borderRadius: '10px', color: '#FFD700', textAlign: 'center', padding: '10px 6px 8px', overflow: 'visible' }}>
            ...
            {[0, 5].map(idx => (
              ...
              <button onClick={() => { dbg('btnClick', `menu[${idx}] clicked isLoggedInExplicit=${isLoggedInExplicit}`); if (!isLoggedInExplicit) { return } setActivePage(String(idx) === activePage ? null : String(idx)) }}
                style={{
...
function SystemPage({ user, lang, langIdx, onChangeLang, onOpenDebug, onDbg, onUserUpdate, onSetSystemMessage, prText, setPrText, prDate, setPrDate, onNavigate }: { user: UserRecord | null; lang: typeof languages[0]; langIdx: number; onChangeLang: (i: number) => void; onOpenDebug: () => void; onDbg: (func: string, msg: string) => void; onUserUpdate: (u: UserRecord) => void; onSetSystemMessage: (m: string) => void; prText: string; setPrText: (v: string) => void; prDate: string; setPrDate: (v: string) => void; onNavigate: (page: string) => void }) {
  const [view, setView] = useState<'none' | 'db' | 'users' | 'schedule' | 'pr' | 'messages' | 'sensitive' | 'tests' | 'data' | 'statistics' | 'billing'>('none')
...
{view === 'users' && (
          <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: 6 }}>
              ...
              <button
                onClick={async () => {
                  if (!newPasswordText || !resetPasswordUser) { setPasswordResetMsg('נא לבחור לקוח ולהקליד סיסמה'); return }
...
const GUIDES_CSS = `
  ...
  .guide-doc .gd-toc button:hover{ color:#1a2238; text-decoration:underline; }
  .guide-doc .gd-toc .gd-n{ font-weight:700; color:#a9781f; font-variant-numeric:tabular-nums; flex:none; min-width:1.4em; }
  .guide-doc .gd-toc .gd-t{ white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
  ...
  .guide-doc.gd-fs .gd-ch-title{ font-size:24px; }
  .guide-doc.gd-fs .gd-body{ font-size:20px; }
  .guide-doc.gd-fs .gd-lede{ font-size:19px; }
  .guide-doc.gd-fs .gd-ch-num{ width:52px; font-size:21px; }
  .guide-doc.gd-fs .gd-toc ol{ column-width:230px; }
  .guide-doc.gd-fs .gd-toc li{ font-size:14px; }
...
type GuideSection = { heading: string; body: string; sub?: boolean; image?: { src: string; width: number; height: number } }
...
const FINANCE_OVERVIEW_SECTIONS: Record<string, GuideSection[]> = {
  he: [
    ...
    { heading: 'השאיפה', body: 'השאיפה היא שניהול תקציב בית תאפשר לייבא דפי חשבון מבנקים וכרטיסי אשראי ממוסדות חובקות עולם, לסווג פעולות, לעקוב אחר הוצאות/הכנסות לאורך זמן ולתכנן קדימה. כלי אחיד שמשלב את כולם לתמונה חודשית/שנתית אחת, זיהוי אוטומטי של פורמט הנתונים, סווג כל עסקה והצגתה. הניתוח המקיף מתבצע בממשק פשוט וב-11 שפות.' },
    ...
    { heading: 'ארכיטקטורה - שכבות המערכת', body: 'ניהול תקציב בית – M Finance\n\n**אוטומציה מלאה ונטולת מאמץ של ניתוח הנתונים המורכב:** המשתמש פשוט טוען קבצים גולמיים יחידים, או תיקיית קבצים בלחיצת כפתור אחת ומקבל תמונת מצב פיננסית מעובדת, מוצלבת ומסווגת תוך שניות, במסך עבודה מקצועי.\n\n**הבנה סמנטית של חופש הקובץ:** אפליקציות פיננסיות מסורתיות מסתמכות על תבניות קבועות (Parsing Rules) ונשברות בכל פעם שהבנק או חברת האשראי משנים עמודה, רווח או פורמט בקובץ ה-Excel/CSV. המנוע של האפליקציה מבין את תוכן השורות קונטקסטואלית, ללא תלות במבנה המדויק.\n\n**דיוק בסיווג קטגוריות:** ניתוח טקסטואלי חכם של תיאורי תנועות עמומים (שמות בתי עסק מקוצרים או קודים של ספקים) והתאמתם המדויקת לעץ הקטגוריות של המשתמש.\n\n**תמונת מצב אחודה במקום אחד:** היכולת לטעון, לעבד ולהצליב בו-זמנית 4 (או יותר) דפי חשבון בנק וכרטיסי אשראי שונים בריצה אחת.\n\n**זיהוי כפילויות והעברות פנימיות:** זיהוי אוטומטי של תנועות מקבילות, פיענוח דפי חשבון בטווחים שונים עם פעולות זהות או דומות.\n\n**עבודה עם נתונים מורכבים:** האפליקציה מיועדת לעבודה רצינית מול טבלאות רחבות, מסננים מרובים, עצי קטגוריות והצלבות נתונים עמוקות.\n\n**תכנון עתידי בפריסה חכמה:** פרק הכולל שורות של הוצאות או הכנסות עתידיות, בפריסת תשלומים או ערך קבוע. האפליקציה דואגת לסנכרן חודשים פעילים, חודשים שעברו וחודשים עתידיים. הצגת הדף השנתי בשילוב עם התכנון העתידי.\n\n**שילוב חכם עם כרטיסי אשראי:** שילוב והצגת הפעולות בכרטיסי האשראי עם דף החשבון החודשי. הצגה מורחבת או מצומצמת בתצוגת טבלאות ובהצגה גרפית.\n\n**שימוש באינטליגנציה מלאכותית, שרת מרכזי והצפנת נתונים:** בטעינה ראשונה הנתונים עוברים מיפוי, סיווג, הצפנה וזיכרון נלמד. מרגע זה כל הקבצים במיפוי דומה נטענים בשניות בודדות.' },
  ...
  en: [
    ...
    { heading: 'Architecture - System Layers', body: "Home Budget Management – M Finance\n\n**Full, effortless automation of the complex analysis of data:** the user simply loads individual raw files, or a folder of files with a single click, and receives a processed, cross-referenced and categorized financial picture within seconds, on a professional work screen.\n\n**Semantic understanding of file freedom:** traditional financial applications rely on fixed templates (Parsing Rules) and break every time the bank or credit card company changes a column, a space or the format of the Excel/CSV file. The application's engine understands the content of the rows contextually, regardless of the exact structure.\n\n**Precise category classification:** smart textual analysis of vague transaction descriptions (abbreviated business names or supplier codes) and their precise matching to the user's category tree.\n\n**A unified picture in one place:** the ability to load, process and cross-reference 4 (or more) different bank statements and credit cards simultaneously in a single run.\n\n**Detection of duplicates and internal transfers:** automatic detection of parallel transactions, decoding of account statements covering different ranges with identical or similar transactions.\n\n**Working with complex data:** the application is designed for serious work with wide tables, multiple filters, category trees and deep data cross-referencing.\n\n**Future planning with smart distribution:** a section containing rows of future expenses or income, spread over installments or as a fixed amount. The application synchronizes active months, past months and future months. The annual page is displayed together with the future planning.\n\n**Smart integration with credit cards:** credit card transactions are integrated and displayed together with the monthly account statement. Expanded or collapsed display, in table view and in graphical view.\n\n**Use of artificial intelligence, a central server and data encryption:** on the first load, the data undergoes mapping, classification, encryption and learned memory. From that moment on, all files with a similar mapping load within seconds." },
  ...
  ru: [
    ...
    { heading: 'Архитектура — слои системы', body: 'Управление домашним бюджетом – M Finance\n\n**Полная автоматизация сложного анализа данных без усилий:** пользователь просто загружает отдельные исходные файлы или папку с файлами одним нажатием кнопки и за считанные секунды получает обработанную, сопоставленную и классифицированную финансовую картину на профессиональном рабочем экране.\n\n**Семантическое понимание свободного формата файла:** традиционные финансовые приложения опираются на фиксированные шаблоны (Parsing Rules) и перестают работать каждый раз, когда банк или компания кредитных карт меняет столбец, пробел или формат файла Excel/CSV. Движок приложения понимает содержание строк контекстуально, независимо от точной структуры.\n\n**Точная классификация по категориям:** интеллектуальный текстовый анализ неясных описаний операций (сокращённых названий предприятий или кодов поставщиков) и их точное сопоставление с деревом категорий пользователя.\n\n**Единая картина в одном месте:** возможность одновременно загружать, обрабатывать и сопоставлять 4 (или более) различные банковские выписки и кредитные карты за один запуск.\n\n**Выявление дубликатов и внутренних переводов:** автоматическое выявление параллельных операций, расшифровка выписок за разные периоды с одинаковыми или похожими операциями.\n\n**Работа со сложными данными:** приложение предназначено для серьёзной работы с широкими таблицами, множеством фильтров, деревьями категорий и глубоким сопоставлением данных.\n\n**Планирование будущего с умным распределением:** раздел, содержащий строки будущих расходов или доходов, с распределением на платежи или в виде фиксированной суммы. Приложение синхронизирует активные, прошедшие и будущие месяцы. Годовая страница отображается вместе с планированием будущего.\n\n**Умная интеграция с кредитными картами:** операции по кредитным картам объединяются и отображаются вместе с ежемесячной выпиской по счёту. Развёрнутое или свёрнутое отображение в табличном и графическом виде.\n\n**Использование искусственного интеллекта, центрального сервера и шифрования данных:** при первой загрузке данные проходят сопоставление, классификацию, шифрование и сохранение в обучаемой памяти. С этого момента все файлы с похожей структурой загружаются за считанные секунды.' },
  ...
  de: [
    ...
    { heading: 'Die Vision', body: 'Die Vision ist, dass die Haushaltsbudgetverwaltung den Import von Kontoauszügen von Banken und Kreditkarten von Instituten weltweit ermöglicht, um Transaktionen zu klassifizieren, Ausgaben/Einnahmen über die Zeit zu verfolgen und vorausschauend zu planen. Ein einheitliches Werkzeug, das alles zu einem monatlichen/jährlichen Gesamtbild zusammenführt, automatische Erkennung des Datenformats, Klassifizierung jeder Transaktion und deren Darstellung. Die umfassende Analyse erfolgt über eine einfache Oberfläche in 11 Sprachen.' },
    ...
    { heading: 'Architektur – Systemschichten', body: 'Haushaltsverwaltung – M Finance\n\n**Vollständige, mühelose Automatisierung der komplexen Datenanalyse:** Der Benutzer lädt einfach einzelne Rohdateien oder einen Ordner mit Dateien per Knopfdruck und erhält innerhalb von Sekunden ein verarbeitetes, abgeglichenes und kategorisiertes Finanzbild auf einem professionellen Arbeitsbildschirm.\n\n**Semantisches Verständnis freier Dateiformate:** Herkömmliche Finanzanwendungen stützen sich auf feste Vorlagen (Parsing Rules) und versagen jedes Mal, wenn die Bank oder das Kreditkartenunternehmen eine Spalte, ein Leerzeichen oder das Format der Excel/CSV-Datei ändert. Die Engine der Anwendung versteht den Inhalt der Zeilen kontextuell, unabhängig von der genauen Struktur.\n\n**Präzise Kategorisierung:** intelligente Textanalyse unklarer Buchungsbeschreibungen (abgekürzte Geschäftsnamen oder Lieferantencodes) und deren präzise Zuordnung zum Kategoriebaum des Benutzers.\n\n**Ein einheitliches Gesamtbild an einem Ort:** die Möglichkeit, 4 (oder mehr) verschiedene Kontoauszüge und Kreditkarten gleichzeitig in einem einzigen Durchlauf zu laden, zu verarbeiten und abzugleichen.\n\n**Erkennung von Duplikaten und internen Überweisungen:** automatische Erkennung paralleler Buchungen, Auswertung von Kontoauszügen mit unterschiedlichen Zeiträumen und identischen oder ähnlichen Buchungen.\n\n**Arbeiten mit komplexen Daten:** Die Anwendung ist für ernsthafte Arbeit mit breiten Tabellen, mehreren Filtern, Kategoriebäumen und tiefgehenden Datenabgleichen konzipiert.\n\n**Zukunftsplanung mit intelligenter Verteilung:** ein Bereich mit Zeilen zukünftiger Ausgaben oder Einnahmen, verteilt auf Raten oder als fester Betrag. Die Anwendung synchronisiert aktive, vergangene und zukünftige Monate. Die Jahresseite wird zusammen mit der Zukunftsplanung angezeigt.\n\n**Intelligente Einbindung von Kreditkarten:** Kreditkartenbuchungen werden mit dem monatlichen Kontoauszug zusammengeführt und angezeigt. Erweiterte oder reduzierte Darstellung in Tabellenansicht und grafischer Ansicht.\n\n**Einsatz künstlicher Intelligenz, eines zentralen Servers und Datenverschlüsselung:** Beim ersten Laden durchlaufen die Daten Zuordnung, Klassifizierung, Verschlüsselung und ein lernendes Gedächtnis. Ab diesem Moment werden alle Dateien mit ähnlicher Zuordnung in wenigen Sekunden geladen.' },
  ...
  fr: [
    ...
    { heading: 'Architecture - couches du système', body: "Gestion du budget familial – M Finance\n\n**Automatisation complète et sans effort de l'analyse complexe des données :** l'utilisateur charge simplement des fichiers bruts individuels, ou un dossier de fichiers en un seul clic, et obtient en quelques secondes une situation financière traitée, recoupée et classée, sur un écran de travail professionnel.\n\n**Compréhension sémantique de la liberté du fichier :** les applications financières traditionnelles reposent sur des modèles fixes (Parsing Rules) et cessent de fonctionner chaque fois que la banque ou la société de carte de crédit modifie une colonne, un espace ou le format du fichier Excel/CSV. Le moteur de l'application comprend le contenu des lignes de manière contextuelle, indépendamment de la structure exacte.\n\n**Classification précise par catégories :** analyse textuelle intelligente des descriptions de transactions ambiguës (noms de commerces abrégés ou codes de fournisseurs) et leur correspondance précise avec l'arborescence de catégories de l'utilisateur.\n\n**Une vue unifiée en un seul endroit :** la possibilité de charger, traiter et recouper simultanément 4 (ou plus) relevés bancaires et cartes de crédit différents en une seule exécution.\n\n**Détection des doublons et des transferts internes :** détection automatique des transactions parallèles, analyse de relevés couvrant des périodes différentes avec des opérations identiques ou similaires.\n\n**Travail avec des données complexes :** l'application est conçue pour un travail sérieux sur des tableaux larges, des filtres multiples, des arborescences de catégories et des recoupements de données approfondis.\n\n**Planification future avec répartition intelligente :** une section contenant des lignes de dépenses ou de revenus futurs, réparties en versements ou sous forme de montant fixe. L'application synchronise les mois actifs, passés et futurs. La page annuelle est affichée en combinaison avec la planification future.\n\n**Intégration intelligente des cartes de crédit :** les opérations des cartes de crédit sont intégrées et affichées avec le relevé de compte mensuel. Affichage détaillé ou réduit, en vue tableau et en vue graphique.\n\n**Utilisation de l'intelligence artificielle, d'un serveur central et du chiffrement des données :** lors du premier chargement, les données passent par le mappage, la classification, le chiffrement et une mémoire apprise. À partir de ce moment, tous les fichiers au mappage similaire se chargent en quelques secondes." },
  ...
  es: [
    ...
    { heading: 'Arquitectura - capas del sistema', body: 'Gestión del presupuesto familiar – M Finance\n\n**Automatización completa y sin esfuerzo del análisis de datos complejo:** el usuario simplemente carga archivos sin procesar individuales, o una carpeta de archivos con un solo clic, y obtiene en segundos una situación financiera procesada, cruzada y clasificada, en una pantalla de trabajo profesional.\n\n**Comprensión semántica de la libertad del archivo:** las aplicaciones financieras tradicionales dependen de plantillas fijas (Parsing Rules) y fallan cada vez que el banco o la compañía de tarjetas de crédito cambia una columna, un espacio o el formato del archivo Excel/CSV. El motor de la aplicación entiende el contenido de las filas de forma contextual, sin depender de la estructura exacta.\n\n**Precisión en la clasificación por categorías:** análisis textual inteligente de descripciones de movimientos ambiguas (nombres de comercios abreviados o códigos de proveedores) y su correspondencia precisa con el árbol de categorías del usuario.\n\n**Una visión unificada en un solo lugar:** la capacidad de cargar, procesar y cruzar simultáneamente 4 (o más) extractos bancarios y tarjetas de crédito diferentes en una sola ejecución.\n\n**Detección de duplicados y transferencias internas:** detección automática de movimientos paralelos, interpretación de extractos de distintos periodos con operaciones idénticas o similares.\n\n**Trabajo con datos complejos:** la aplicación está diseñada para un trabajo serio con tablas amplias, múltiples filtros, árboles de categorías y cruces de datos profundos.\n\n**Planificación futura con distribución inteligente:** una sección que incluye filas de gastos o ingresos futuros, distribuidos en cuotas o como importe fijo. La aplicación sincroniza los meses activos, los meses pasados y los meses futuros. La página anual se muestra junto con la planificación futura.\n\n**Integración inteligente con tarjetas de crédito:** los movimientos de las tarjetas de crédito se integran y se muestran junto con el extracto mensual de la cuenta. Visualización ampliada o reducida, en vista de tablas y en vista gráfica.\n\n**Uso de inteligencia artificial, un servidor central y cifrado de datos:** en la primera carga, los datos pasan por mapeo, clasificación, cifrado y memoria aprendida. A partir de ese momento, todos los archivos con un mapeo similar se cargan en pocos segundos.' },
  ...
  ja: [
    ...
    { heading: '目指す姿', body: '目指す姿は、家計管理が世界中の金融機関からの銀行およびクレジットカードの明細書のインポートを可能にすることです。取引を分類し、時間の経過とともに支出/収入を追跡し、先を見越して計画します。すべてを一つの月次/年次の全体像に統合する統一ツール、データ形式の自動認識、各取引の分類と表示。包括的な分析はシンプルなインターフェースで、11言語で行われます。' },
    { heading: 'インストールとアップデート', body: 'インストールとアップデートはKeyClickのウェブサイトを通じて、お客様には見えない形で行われるため、特別な操作をすることなく常に最新バージョンで利用できます。' },
    { heading: 'アーキテクチャ - システムの層', body: '家計管理 – M Finance\n\n**複雑なデータ分析の完全かつ手間いらずの自動化：** ユーザーは個別の元ファイル、またはファイルの入ったフォルダーをボタン一つで読み込むだけで、処理・照合・分類済みの財務状況を数秒でプロフェッショナルな作業画面に得られます。\n\n**ファイル形式の自由さのセマンティックな理解：** 従来の財務アプリは固定テンプレート（Parsing Rules）に依存しており、銀行やクレジットカード会社がExcel/CSVファイルの列、スペース、形式を変更するたびに機能しなくなります。本アプリのエンジンは、正確な構造に依存せず、行の内容を文脈から理解します。\n\n**正確なカテゴリー分類：** あいまいな取引明細（省略された店舗名や業者コード）をスマートにテキスト分析し、ユーザーのカテゴリーツリーに正確に割り当てます。\n\n**一か所にまとまった全体像：** 4つ（またはそれ以上）の異なる銀行明細とクレジットカードを、一度の実行で同時に読み込み、処理し、照合できます。\n\n**重複と内部振替の検出：** 並行する取引を自動的に検出し、同一または類似の取引を含む異なる期間の明細を解析します。\n\n**複雑なデータの操作：** 本アプリは、幅の広い表、複数のフィルター、カテゴリーツリー、詳細なデータ照合を用いた本格的な作業向けに設計されています。\n\n**スマートな配分による将来計画：** 将来の支出や収入の行を、分割払いまたは固定額で配分するセクションです。アプリは現在の月、過去の月、将来の月を同期し、年間ページを将来計画と組み合わせて表示します。\n\n**クレジットカードとのスマートな連携：** クレジットカードの取引を月次口座明細と統合して表示します。表形式およびグラフ表示で、詳細表示と簡略表示を切り替えられます。\n\n**人工知能、中央サーバー、データ暗号化の活用：** 初回読み込み時に、データはマッピング、分類、暗号化、学習メモリーの処理を受けます。それ以降、同様のマッピングのファイルはすべて数秒で読み込まれます。' },
  ...
  ar: [
    ...
    { heading: 'البنية - طبقات النظام', body: 'إدارة الميزانية المنزلية – M Finance\n\n**أتمتة كاملة ودون عناء لتحليل البيانات المعقد:** يقوم المستخدم ببساطة بتحميل ملفات خام فردية، أو مجلد ملفات بنقرة زر واحدة، ويحصل خلال ثوانٍ على صورة مالية معالجة ومتقاطعة ومصنفة، على شاشة عمل احترافية.\n\n**فهم دلالي لحرية تنسيق الملف:** تعتمد التطبيقات المالية التقليدية على قوالب ثابتة (Parsing Rules) وتتعطل في كل مرة يغيّر فيها البنك أو شركة بطاقات الائتمان عمودًا أو مسافة أو تنسيق ملف Excel/CSV. يفهم محرك التطبيق محتوى الصفوف حسب السياق، دون الاعتماد على البنية الدقيقة.\n\n**دقة في تصنيف الفئات:** تحليل نصي ذكي لأوصاف الحركات الغامضة (أسماء المتاجر المختصرة أو رموز الموردين) ومطابقتها بدقة مع شجرة فئات المستخدم.\n\n**صورة موحدة في مكان واحد:** القدرة على تحميل ومعالجة ومطابقة 4 (أو أكثر) كشوف حسابات بنكية وبطاقات ائتمان مختلفة في آنٍ واحد وفي تشغيل واحد.\n\n**اكتشاف التكرارات والتحويلات الداخلية:** اكتشاف تلقائي للحركات المتوازية، وتحليل كشوف حسابات لفترات مختلفة تحتوي على عمليات متطابقة أو متشابهة.\n\n**العمل مع بيانات معقدة:** التطبيق مصمم للعمل الجاد مع جداول واسعة ومرشحات متعددة وأشجار فئات ومطابقات بيانات عميقة.\n\n**تخطيط مستقبلي بتوزيع ذكي:** قسم يتضمن صفوفًا من النفقات أو الإيرادات المستقبلية، موزعة على أقساط أو بمبلغ ثابت. يتولى التطبيق مزامنة الأشهر النشطة والأشهر الماضية والأشهر المستقبلية، وعرض الصفحة السنوية مع التخطيط المستقبلي.\n\n**تكامل ذكي مع بطاقات الائتمان:** دمج وعرض عمليات بطاقات الائتمان مع كشف الحساب الشهري. عرض موسّع أو مختصر في عرض الجداول وفي العرض البياني.\n\n**استخدام الذكاء الاصطناعي وخادم مركزي وتشفير البيانات:** عند التحميل الأول تمر البيانات بعمليات التعيين والتصنيف والتشفير والذاكرة المكتسبة. ومن تلك اللحظة يتم تحميل جميع الملفات ذات التعيين المشابه في ثوانٍ معدودة.' },
  ...
  zh: [
    ...
    { heading: '愿景', body: '愿景是家庭预算管理能够从世界各地的机构导入银行和信用卡对账单，对交易进行分类，随时间跟踪支出/收入并提前规划。一个统一的工具，将所有内容整合成一个月度/年度全貌，自动识别数据格式，对每笔交易进行分类并呈现。全面的分析通过简单的界面完成，支持11种语言。' },
    { heading: '安装与更新', body: '安装和更新通过 KeyClick 网站进行，对客户透明，因此客户始终使用最新版本，无需采取任何操作。' },
    { heading: '架构 - 系统分层', body: '家庭预算管理 – M Finance\n\n**数据的复杂分析的全面、轻松自动化：** 用户只需一键加载单个原始文件或整个文件夹，即可在几秒钟内于专业的工作界面上获得经过处理、交叉核对和分类的财务概况。\n\n**对文件格式自由度的语义理解：** 传统财务应用依赖固定模板（Parsing Rules），每当银行或信用卡公司更改 Excel/CSV 文件中的列、空格或格式时就会失效。本应用的引擎能够根据上下文理解各行内容，而不依赖于确切的结构。\n\n**精准的类别分类：** 对含义模糊的交易描述（缩写的商户名称或供应商代码）进行智能文本分析，并将其精准匹配到用户的类别树。\n\n**统一的全局视图：** 能够在一次运行中同时加载、处理并交叉核对 4 个（或更多）不同的银行对账单和信用卡。\n\n**识别重复与内部转账：** 自动识别并行交易，解析不同时间范围内包含相同或相似交易的对账单。\n\n**处理复杂数据：** 本应用专为宽表格、多重筛选、类别树和深度数据交叉核对等严肃工作而设计。\n\n**智能分配的未来规划：** 该部分包含未来支出或收入的条目，可按分期或固定金额分配。应用会同步当前月份、过去月份和未来月份，并将年度页面与未来规划结合显示。\n\n**与信用卡的智能整合：** 将信用卡交易与月度账户对账单整合显示。支持表格视图和图形视图中的展开或收起显示。\n\n**运用人工智能、中央服务器和数据加密：** 首次加载时，数据会经过映射、分类、加密和学习记忆处理。从此以后，所有映射相似的文件都能在几秒钟内加载完成。' },
  ...
  it: [
    ...
    { heading: 'Architettura - livelli del sistema', body: "Gestione del budget familiare – M Finance\n\n**Automazione completa e senza sforzo dell'analisi complessa dei dati:** l'utente carica semplicemente singoli file grezzi, o una cartella di file con un solo clic, e ottiene in pochi secondi un quadro finanziario elaborato, incrociato e classificato, su una schermata di lavoro professionale.\n\n**Comprensione semantica della libertà del file:** le applicazioni finanziarie tradizionali si basano su modelli fissi (Parsing Rules) e smettono di funzionare ogni volta che la banca o la società della carta di credito modifica una colonna, uno spazio o il formato del file Excel/CSV. Il motore dell'applicazione comprende il contenuto delle righe in modo contestuale, indipendentemente dalla struttura esatta.\n\n**Precisione nella classificazione per categorie:** analisi testuale intelligente delle descrizioni ambigue dei movimenti (nomi di esercizi abbreviati o codici di fornitori) e loro corrispondenza precisa con l'albero delle categorie dell'utente.\n\n**Un quadro unificato in un unico posto:** la possibilità di caricare, elaborare e incrociare contemporaneamente 4 (o più) estratti conto bancari e carte di credito diversi in un'unica esecuzione.\n\n**Rilevamento di duplicati e trasferimenti interni:** rilevamento automatico di movimenti paralleli, interpretazione di estratti conto relativi a periodi diversi con operazioni identiche o simili.\n\n**Lavoro con dati complessi:** l'applicazione è progettata per un lavoro serio con tabelle ampie, filtri multipli, alberi di categorie e incroci di dati approfonditi.\n\n**Pianificazione futura con distribuzione intelligente:** una sezione che comprende righe di spese o entrate future, distribuite in rate o come importo fisso. L'applicazione sincronizza i mesi attivi, i mesi passati e i mesi futuri. La pagina annuale viene visualizzata insieme alla pianificazione futura.\n\n**Integrazione intelligente con le carte di credito:** i movimenti delle carte di credito vengono integrati e visualizzati insieme all'estratto conto mensile. Visualizzazione estesa o ridotta, in vista tabellare e in vista grafica.\n\n**Uso dell'intelligenza artificiale, di un server centrale e della crittografia dei dati:** al primo caricamento i dati vengono sottoposti a mappatura, classificazione, crittografia e memoria appresa. Da quel momento tutti i file con una mappatura simile si caricano in pochi secondi." },
  ...
  hi: [
    ...
    { heading: 'आकांक्षा', body: 'आकांक्षा यह है कि गृह बजट प्रबंधन दुनिया भर के संस्थानों से बैंक और क्रेडिट कार्ड स्टेटमेंट आयात करने में सक्षम बनाए, लेन-देन को वर्गीकृत करने, समय के साथ व्यय/आय को ट्रैक करने और आगे की योजना बनाने के लिए। एक एकीकृत उपकरण जो सब कुछ एक मासिक/वार्षिक चित्र में जोड़ता है, डेटा प्रारूप की स्वचालित पहचान, प्रत्येक लेन-देन का वर्गीकरण और उसकी प्रस्तुति। व्यापक विश्लेषण एक सरल इंटरफ़ेस के माध्यम से, 11 भाषाओं में किया जाता है।' },
    ...
    { heading: 'आर्किटेक्चर - सिस्टम की परतें', body: 'घरेलू बजट प्रबंधन – M Finance\n\n**डेटा के जटिल विश्लेषण का पूर्ण और सहज स्वचालन:** उपयोगकर्ता बस एक-एक कच्ची फ़ाइल, या एक ही बटन क्लिक से फ़ाइलों का पूरा फ़ोल्डर लोड करता है और कुछ ही सेकंड में एक पेशेवर कार्य-स्क्रीन पर संसाधित, मिलान किया हुआ और वर्गीकृत वित्तीय चित्र प्राप्त करता है।\n\n**फ़ाइल की स्वतंत्रता की अर्थपूर्ण समझ:** पारंपरिक वित्तीय एप्लिकेशन निश्चित टेम्पलेट (Parsing Rules) पर निर्भर करते हैं और हर बार तब विफल हो जाते हैं जब बैंक या क्रेडिट कार्ड कंपनी Excel/CSV फ़ाइल में कोई कॉलम, रिक्त स्थान या प्रारूप बदलती है। एप्लिकेशन का इंजन सटीक संरचना पर निर्भर हुए बिना, पंक्तियों की सामग्री को संदर्भ के अनुसार समझता है।\n\n**श्रेणी वर्गीकरण में सटीकता:** अस्पष्ट लेन-देन विवरणों (संक्षिप्त व्यापार नाम या आपूर्तिकर्ता कोड) का स्मार्ट पाठ्य विश्लेषण और उपयोगकर्ता के श्रेणी वृक्ष से उनका सटीक मिलान।\n\n**एक ही स्थान पर एकीकृत चित्र:** एक ही रन में 4 (या अधिक) अलग-अलग बैंक खाता विवरण और क्रेडिट कार्ड एक साथ लोड करने, संसाधित करने और मिलान करने की क्षमता।\n\n**डुप्लिकेट और आंतरिक स्थानांतरण की पहचान:** समानांतर लेन-देन की स्वचालित पहचान, समान या मिलते-जुलते लेन-देन वाले विभिन्न अवधियों के खाता विवरणों का विश्लेषण।\n\n**जटिल डेटा के साथ काम:** यह एप्लिकेशन चौड़ी तालिकाओं, एकाधिक फ़िल्टरों, श्रेणी वृक्षों और गहन डेटा मिलान के साथ गंभीर काम के लिए बनाया गया है।\n\n**स्मार्ट वितरण के साथ भविष्य की योजना:** एक खंड जिसमें भविष्य के खर्चों या आय की पंक्तियाँ होती हैं, किस्तों में या निश्चित राशि के रूप में वितरित। एप्लिकेशन सक्रिय महीनों, बीते महीनों और भविष्य के महीनों को सिंक करता है। वार्षिक पृष्ठ भविष्य की योजना के साथ प्रदर्शित होता है।\n\n**क्रेडिट कार्ड के साथ स्मार्ट एकीकरण:** क्रेडिट कार्ड के लेन-देन को मासिक खाता विवरण के साथ जोड़कर प्रदर्शित करना। तालिका दृश्य और ग्राफ़िकल दृश्य में विस्तृत या संक्षिप्त प्रदर्शन।\n\n**कृत्रिम बुद्धिमत्ता, केंद्रीय सर्वर और डेटा एन्क्रिप्शन का उपयोग:** पहली बार लोड करने पर डेटा मैपिंग, वर्गीकरण, एन्क्रिप्शन और सीखी हुई स्मृति से गुज़रता है। उसी क्षण से समान मैपिंग वाली सभी फ़ाइलें कुछ ही सेकंड में लोड हो जाती हैं।' },
...
const FINANCE_GUIDE_SECTIONS: Record<string, GuideSection[]> = {
  he: [
    ...
    { heading: 'דף הבית של ניהול תקציב בית', body: 'לחצתם על הכפתור מאתר KeyClick ונפתחת תצוגת שער הכניסה, גליל מסוגנן עם ברכת כניסה ודגל השפה.\n\nהשפה לא מתאימה ? בחרו 1 מתוך 11 הדגלים בראש האתר ותועברו מידית לשפה הנבחרת. מערכת ריבוי השפות הוא אחד מיחידות הבסיס של האתר ומוצריו. תוכלו בכל עת לעבור מידית משפה לשפה.\n\nלחיצה על המסך תסגור את מסך השער ותפתח את תכולת הפרויקט.' },
    { heading: 'בחירת שפה', body: 'בראש המסך תמצאו שורת דגלים - דגל לכל אחת מ-11 השפות הנתמכות בתוכנה. לחיצה על דגל כלשהו מחליפה מיידית את כל התוכנה לאותה שפה - כל הכותרות, כל התוויות, כל הודעות המערכת. תוכלו לעבור בין שפות בכל רגע, ולחזור בחזרה, בלי לאבד שום נתון.' },
    { heading: 'התחלת עבודה', body: 'לחצתם על מסך הכניסה ונכנסתם לאפליקציה. מה אתם רואים? מה עליכם לעשות?\n\nעל מנת לנהל תקציב יש קודם כל לטעון את הנתונים. מה הדרכים לטעינה. מספר מסלולים לטעינה. בתהליך הטעינה תקבלו הנחיות והודעות.\n\nאם הכנתם מראש קבצים לטעינה, קבצי xls, xlsx, csv, אז אתם מוכנים לטעינה. תפריט טעינה אשר בלוח הבקרה מאפשר לכם את הדברים הבאים: טעינת קובץ בודד, טעינת תיקיה עם כל הקבצים בה בלחיצה אחת אוטומטית, טעינת תיקיית הקבצים בלחיצה חצי אוטומטית, כלומר תקבלו הודעה על קובץ ותוכלו לבחור אם לטעון אותו או לא.\n\nתהליך הטעינה מתחלק לשני שלבים:\nשלב 1 הוא כאשר האפליקציה פוגשת לראשונה קובץ טעינה לא מוכר. ברגע זה מופעל אלגוריתם חכם, אשר בסיומו מתקבלת טביעת האצבע של הקובץ, מיפוי מדויק של נתוני הקובץ.\nשלב 2 הוא כל הטעינות הבאות, דפי חשבון ואשראי בכל זמן שהוא, יטענו במהירות שיא ותתקבל תמונת מצב מידית.\n\nבדומה למיפוי פורמט הנתונים בקובץ, בתהליך הטעינה מתבצע סיווג חכם של הפעולות, הוצאות והכנסות הנטענות מהקובץ. לאחר הסיווג החכם, ניתנת למשתמש לשנות סיווגים לאחד מרשימת הסיווגים הקיימת. כל הסיווגים הללו נשמרים בזכרון נלמד. בכל טעינה אחרת, הזכרון הזה נקרא.\n\nסיום הטעינה. מה אתם רואים? דף חשבון שנתי, פריסה שנתית. טבלת מאזן, יתרה, טבלת הפעולות שנטענו, מסווגות לפי נושאים.' },
    ...
    { heading: 'תצוגה חודשית', body: 'ברצונכם לטפל רק בחודש מסוים, לחצו בלוח הבקרה על תצוגה חודשית. יפתח בפניכם דף הכולל נגזרת של חודש מסוים מהדף השנתי. כאן תוכלו לבחור כל חודש ומיד תקבלו את הנתונים למסך.' },
    { heading: 'לוחות הודעות', body: 'בתחתית במסך, באופן קבוע קיימים שלושה לוחות להודעות המערכת, הודעות שוטפות, מידע ושגיאות אפשריות.' },
    { heading: 'לוח הבקרה', body: 'מבט ימינה מביא אותנו ללוח בקרה של האתר. לוח הבקרה מצד ימין תמיד גלוי בפניכם,\n\nכל אחד מהפריטים על לוח הבקרה נועד למלא פונקציה של הצגה מקומית או מעבר לדף אחר. בהמשך במסמך זה יפורטו כל הפריטים הללו.' },
    { heading: 'צד לוח הבקרה', body: 'אם אתם ימניים או שמאליים, תוכלו ללחוץ על כפתור ימין או שמאל בלוח הבקרה ולוח הבקרה יעבור מצד לצד.' },
    ...
    { heading: 'סיום עבודה', body: 'סיימתם עבודה וברצונכם לסגור את האפליקציה. לחצו צא.' },
    { heading: 'תהליך טעינה ידנית', body: 'תהליך טעינה ידנית מייושם על ידי כפתורי הטעינה בלוח הבקרה. לפני הטעינה תוכלו לבחור לטעון קובץ אחד מסויים, בחרו קובץ, טעינת כל הקבצים בתיקיה, לחצו תיקיה, טעינה אוטומוית של כל הקבצים בתיקיה, לחצו אוטומטי או בכל קובץ תקבלו בקשת אישור. בחרתם אופן הטעינה, לחצו על כפתור טען. ייפתח בפניכם מנהל קבצים, בחרו קובץ או תיקיה ואשרו.' },
    { heading: 'תצוגת מספרי חשבון', body: 'לצד כפתורי הטעינה יש לכם תווית "מס. חשבון" עם תיבות סימון . המידע הזה נשלף לאחר תהליך הטעינה מתוך הנתונים. בחרו חשבון אחד או יותר להתמקדות המערכת (עד 4 חשבונות שונים).' },
    { heading: 'מסך המסד', body: 'טענתם נתונים מתוך דפי חשבון ואתם רוצים לראות את הטעינה הגולמית איך שזה נטען, לחצו על כפתור המסד בלוח הבקרה וגלגלו להצגה הרצויה.' },
    { heading: 'עמוד הסווגים', body: 'תוכלו לפתוח את עמוד הסווגים ולראות את כל הטבלאות.\n\nאם פעולה מסויימת לא בסווג הנכון, לחצו על עריכה, קבעו את הסווג הנכון, לחצו על עדכון. המערכת תזכור את הבחירה גם לטעינות הבאות.' },
    { heading: 'תצוגה גרפית ועוגת התקציב', body: 'בפאנל הבקרה יש בפניכם רשימה של תצוגות (דף חשבון). בחרו תצוגה גרפית. מסך תצוגה שנתית גרפית תפתח בפניכם. כאן תוכלו לבחור כל מה שעולה על דעתכם, כל סעיף אותו תרצו לבחון לאורך הזמן בהצגה גרפית.\n\nאתם בדף הגרפי, ברצונכם לקבל מושג יותר עמוק וגם לחוות חוויה טכנולוגית מדהימה, לחצו על עוגת התקציב. בתצוגה זו תוכלו לבחור את החודש הרצוי ולראות את הפריסה של ההוצאות על גבי ההכנסות. בדף העוגה, הטבלה מימין עם הבוררים מאפשרת לכם לשלוט על פרוסות העוגה. להוריד או להעלות את ערכה. בביצוע הוויסות של הפרוסות תוכלו להגיע לערכים רצויים לקבלת האיזון הרצוי לכם.' },
    { heading: 'כרטיסי אשראי', body: 'עברו ללוח הבקרה, לחצו על כרטיסי האשראי ותוכלו לראות את כל הכרטיסים. בחרו כרטיס ותקבלו פירוט.' },
    { heading: 'תכנון עתידי', body: 'עברו שוב ללוח הבקרה, לחצו על תכנון עתידי. לתכנון פעולות לחצו ותפתח כרטיסייית עריכה. בחרו את המוסד הפיננסי, מספר החשבון, את סיווג הפעולה, רשמו תיאור הפעולה, הערה, סכום לחיוב או לזכות וכן בכמה חודשים מדובר. בסיום לחצו על עדכון.\n\nלאחר שהכנסתם את הפעולה לטבלת התכנון, תוכלו לשכפל אותה או לשנות אותה. זאת על ידי בחירת השורה ועריכה באותה הכרטיסיה. עקבו אחר ההוראות.\n\nטבלת התכנון העתידי, כמו כרטיסי האשראי, ישולבו במדויק בדף החשבון השנתי, במעקב החודשים הרלוונטיים. עדכון בכל חודש בחודשו. שימו לב שבדפי החשבון השונים, יש ברירה של הצגה וניתוח הנתונים עם תכנון עתידי או בלי, עם פרוט פעולות האשראי או רק הסיכום שלהם.' },
    { heading: 'מעבר בין המסכים', body: 'בפאנל הבקרה תמצאו שבעה כפתורים שמעבירים אתכם בין המסכים המרכזיים של התוכנה:\n\nשנתי, חודשי, סווג, עתידי, מסד, אשראי, גרפי\n\nכל אחד מהם פותח מסך אחר, ואני אסביר על כל אחד מהם בהמשך המדריך.' },
    { heading: 'טעינת קבצים', body: 'זה המקום שבו אתם מכניסים לתוכנה את הקבצים שהורדתם מהבנק או מחברת האשראי (בדרך כלל קבצי Excel או CSV). לחצו על הכפתור "טען", ובחרו איך אתם רוצים לטעון:\n\n•    קובץ - טעינת קובץ בודד\n•    תיקיה - טעינת כל הקבצים שנמצאים בתיקייה מסוימת בבת אחת\n•    אוטומטי - התוכנה טוענת בעצמה, ללא צורך לבחור כל קובץ בנפרד\n\nאינכם צריכים לדאוג לגבי טעינה כפולה של אותו קובץ בטעות - התוכנה מזהה תנועות שכבר קיימות אצלה ולא תוסיף אותן פעמיים. זה אומר שתוכלו בלב שקט לטעון שוב קובץ שכבר טענתם בעבר, בלי חשש שהמספרים "יתנפחו".' },
    { heading: 'חשבונות', body: 'לצד כפתורי הטעינה יש לכם תווית "מס. חשבון" עם תיבות סימון - כאן אתם רואים ויכולים לבחור באילו חשבונות בנק להתמקד (עד 4 חשבונות שונים).' },
    { heading: 'איפוס והתחלה מחדש', body: 'אם בשלב כלשהו תרצו להתחיל מחדש, יש שני כפתורים נפרדים:\n\n•    אפס מסד - מוחק את כל התנועות שנטענו\n•    אפס סיווגים - מוחק את הסיווגים שנקבעו לתנועות\n\nולסיום, כפתור "צא" ליציאה מהתוכנה.' },
    { heading: 'המסך השנתי', body: 'זהו המסך המרכזי של התוכנה, ונקרא "דף חשבון שנתי".\n\nכאן אתם רואים טבלה גדולה אחת: בשורות - כל קטגוריות ההוצאה וההכנסה שלכם, ובעמודות - שלוש שנים שלמות, חודש אחר חודש. בשורה העליונה של הטבלה מופיע לכם סיכום כללי - כמה נכנס, כמה יצא, מה היתרה שהצטברה מהתקופה הקודמת, ומה סך הכל.\n\nאם אתם רוצים לראות בדיוק אילו תנועות עומדות מאחורי סכום מסוים - פשוט לחצו על השורה של הקטגוריה שמעניינת אתכם, והמסך ייפתח לכם גם את הפירוט המלא שלה.\n\nבראש המסך יש לכם כמה כפתורים:\n\n•    עידכון - מרענן את הנתונים בטבלה\n•    ייצוא - שומר את הטבלה כקובץ Excel או PDF, כדי שתוכלו לשמור אותה או להדפיס אותה\n•    ריענון\n•    ניקוי\n\nוכן שני מתגים חשובים שתראו גם במסכים נוספים בהמשך:\n\n•    כולל עתידי - קובע אם הוצאות והכנסות מתוכננות לעתיד (למשל הוראות קבע) ייכללו בחישוב\n•    כולל כרטיסי אשראי - קובע אם תנועות כרטיסי האשראי ייכללו בחישוב' },
    { heading: 'המסך החודשי', body: 'המסך הזה נקרא "דף חשבון חודשי", והוא נותן לכם זום-אין לחודש ספציפי שמעניין אתכם.\n\nלמעלה תוכלו לבחור שנה וחודש, וללחוץ על הכפתור "עדכן" כדי לראות את הנתונים של אותה תקופה.\n\nמה שמיוחד במסך הזה הוא שהוא מרכז עבורכם במקום אחד שמונה טבלאות שונות, כך שאתם רואים את כל התמונה של החודש הנבחר בבת אחת:\n\n•    רשימת הוצאות\n•    ריכוז פעולות על פי סיווג\n•    הכנסות עתידיות\n•    הוצאות עתידיות\n•    חישוב יתרה\n•    מאזן חודשי\n•    כרטיסי אשראי\n•    חשבונות בנק\n\nוגם כאן, שני המתגים "כולל עתידי" ו"כולל כרטיסי אשראי" זמינים לכם, אם תרצו לכלול או להשמיט אותם מהתמונה.' },
    { heading: 'מסך הסיווגים', body: 'המסך הזה נקרא "דף חשבון ממוין סיווגים", וכאן אתם רואים את כל התנועות שלכם מאורגנות לפי קטגוריה - כל מה ששייך ל"מזון", כל מה ששייך ל"רכב", וכן הלאה.\n\nזה גם המקום שבו תוכלו לתקן סיווג שהתוכנה קבעה לא נכון. התוכנה עצמה מנחה אתכם בדיוק מה לעשות: "שינוי הסווג, לחצו: עריכה, בחירת סווג חדש, עידכון"\n\nכלומר - לחצו על עריכה, בחרו את הקטגוריה הנכונה מהרשימה, ולחצו עידכון. חשוב לדעת: כשאתם משנים סיווג של תנועה, התוכנה זוכרת את זה, כך שבפעם הבאה שתטענו תנועה דומה (עם אותו תיאור), היא כבר תסווג אותה נכון מעצמה.\n\nוגם כאן זמינים לכם שני המתגים "כולל עתידי" ו"כולל כרטיסי אשראי".' },
    { heading: 'מסך המסד', body: 'המסך הזה נקרא "מסד נתונים", וזוהי הרשימה הגולמית והמלאה של כל תנועה ותנועה שנטענה לתוכנה - התאריך שלה, הבנק או חברת האשראי שממנה היא הגיעה, התיאור, הסכום, הסיווג שניתן לה, ועוד.\n\nזה המקום שאליו תוכלו לפנות אם אתם רוצים לראות את "כל הנתונים כמו שהם", בלי שום סינון או קיבוץ. כפתור עידכון מרענן את הרשימה.' },
    { heading: 'מסך כרטיסי האשראי', body: 'המסך הזה נקרא "כרטיסי אשראי", וכפי שהוא עצמו מציג לכם: "לפניכם רשימת כרטיסי האשראי, בחרו לפירוט הפעולות"\n\nבחלק העליון תראו טבלה מסכמת של כל כרטיסי האשראי שלכם, חודש אחר חודש, לאורך שלוש שנים - בדיוק כמו במסך השנתי, רק ממוקד בכרטיסי אשראי. כשאתם בוחרים כרטיס מסוים, מופיעה לכם למטה טבלה נוספת עם פירוט לפי בתי העסק שחייבו אותו.\n\nכפתורי רענון וייצוא זמינים גם כאן.' },
    { heading: 'מסך התכנון העתידי', body: 'המסך הזה נקרא "דף חשבון עתידי", וכאן אתם מנהלים הוצאות והכנסות שאתם כבר יודעים עליהן מראש - הוראת קבע, תשלומים, מנוי חודשי, ועוד.\n\nהתוכנה מנחה אתכם: "כרטיסיית פעולה - בחרו שורה או התחילו חדש".\n\nלכל פריט שאתם מוסיפים יש כרטיסייה משלו, עם השדות הבאים:\n\n•    מקור\n•    סיווג\n•    הערה\n•    תיאור\n•    בנק\n•    חשבון\n•    הכנסה או הוצאה\n•    תאריך התחלה\n•    מספר תשלומים\n\nברגע שאתם קובעים תאריך התחלה ומספר תשלומים, התוכנה כבר דואגת לפרוס את הסכום קדימה על פני כל אותם החודשים, ומשלבת אותו אוטומטית בכל שאר המסכים (כשהמתג "כולל עתידי" פעיל).\n\nהפעולות הזמינות לכם: עדכון, חדש, עריכה, איפוס, מחיקה.' },
    { heading: 'מסך הגרפים', body: 'המסך הזה נקרא "דף חשבון בתצוגה גרפית", והוא נותן לכם את אותם הנתונים - אבל בתמונה, לא בטבלה.\n\nתוכלו לבחור בין כמה מצבי תצוגה: מאזן, יתרה, הוצאות, וכן תצוגה ממוקדת לפי סיווג, פריט בודד, תכנון עתידי, או כרטיסי אשראי.' },
    { heading: 'עוגת התקציב', body: 'בתוך מסך הגרפים תמצאו כלי מיוחד בשם "עוגת התקציב", שמטרתו "תכנון מאזן תקציב בית" - זהו כלי לוויסות חי של התקציב שלכם: אתם בוחרים תקופה להצגה (שנה וחודש), ויכולים לגרור ולשנות את החלוקה בין הקטגוריות ולראות מיד איך זה משפיע על האיזון הכללי של התקציב.\n\nהכפתורים הזמינים: עדכן, אפס, רענן.' },
    { heading: 'לוח ההודעות', body: 'בתחתית המסך, לאורך כל העבודה בתוכנה, יש לכם לוח הודעות עם שלושה חלקים:\n\n•    מערכת - מה שקורה כרגע ברקע\n•    הנחייה - טיפים והכוונה\n•    שגיאה - אם משהו לא הצליח, כאן תדעו על כך\n\nתוכלו לנקות את ההודעות בכפתור ניקוי, או לשמור אותן החוצה בכפתור ייצוא.' },
    { heading: 'ניהול תקציב בית M Finance', body: 'אפליקציית ניהול תקציב בית היא גולת הכותרת של הפרויקט. הסבר מלא ופורט תוכלו לקרוא במגירת המסמכים 4,5,6 במדריכים וסרטונים.\n\nבאמצעות האפליקציה תקבלו מבט כולל על הפעולות הבנקאיות שלכם, הכנסות והוצאות, מאזן חודשי ושנתי. תוכלו להוסיף ולתכנן הוצאות או הכנסות עתידיות, בפריסת תשלומים חכמה.\n\nלחצתם על מתג ניהול תקציב בית בפאנל הבקרה, יפתח שער האפליקציה, דף הדומה לשער האתר KeyClick, עם ברכת כניסה בשפה שבחרתם.\n\nהאפליקציה קוראת קבצי חשבונות בנק וכרטיסי אשראי אשר הורדתם מבעוד מועד מחשבונכם במוסד פיננסי ועורכת ניתוח מעמיק לפעולות הבנקאיות בדפים אלה.\n\nיכולות האפליקציה למגוון תצוגות בחתכים שונים ובזמנים שונים, כולל הצגות גרפיות פרטניות.\n\nוהנה הדובדובן שבקצפת -- עוגת תקציב חיה. ההוצאות מוצגות כפרוסות בתוך עוגת ההכנסות. מנגנון חכם מאפשר לכם לשנות את ערכי הפרוסות עד לקבלת מאזן.' },
  ],
  en: [
    ...
    { heading: 'Getting Started', body: "You clicked the entry screen and entered the application. What do you see? What should you do?\n\nTo manage a budget, you first need to load the data. What are the ways to load it. There are several loading routes. During the loading process you'll receive guidance and messages.\n\nIf you prepared files for loading in advance, xls, xlsx, csv files, then you are ready to load. The loading menu in the control panel lets you do the following: load a single file, load a folder with all its files in one automatic click, load the folder of files with a semi-automatic click, meaning you will get a message about a file and can choose whether to load it or not.\n\nThe loading process is divided into two stages:\nStage 1 is when the application first encounters an unfamiliar loading file. At that moment a smart algorithm runs, at the end of which the file's fingerprint is obtained, an exact mapping of the file's data.\nStage 2 is all subsequent loads; account and credit statements, at any time, load at top speed and an immediate snapshot is obtained.\n\nSimilar to mapping the data format in the file, during the loading process a smart classification of the transactions, expenses and income loaded from the file is performed. After the smart classification, the user can change classifications to one from the existing classification list. All these classifications are saved in learned memory. On every other load, this memory is read.\n\nEnd of loading. What do you see? Annual account page, annual layout. Balance table, remaining balance, table of the loaded transactions, classified by category." },
    ...
    { heading: 'Control Panel', body: "Looking to the right brings us to the site's control panel. The control panel is always visible on the right side.\n\nEach of the items on the control panel serves to display something locally or move to another page. All these items are detailed further in this document." },
  ...
  ru: [
    ...
    { heading: 'Начало работы', body: 'Вы нажали на экран входа и вошли в приложение. Что вы видите? Что вам нужно делать?\n\nЧтобы управлять бюджетом, сначала нужно загрузить данные. Какие есть способы загрузки. Есть несколько маршрутов загрузки. В процессе загрузки вы получите указания и сообщения.\n\nЕсли вы заранее подготовили файлы для загрузки — файлы xls, xlsx, csv, — вы готовы к загрузке. Меню загрузки на панели управления позволяет вам следующее: загрузка одного файла, загрузка папки со всеми её файлами одним автоматическим нажатием, загрузка папки файлов полуавтоматическим нажатием, то есть вы получите сообщение о файле и сможете выбрать, загружать его или нет.\n\nПроцесс загрузки делится на два этапа:\nЭтап 1 — когда приложение впервые встречает незнакомый файл загрузки. В этот момент запускается умный алгоритм, по завершении которого получается отпечаток файла — точное сопоставление данных файла.\nЭтап 2 — все последующие загрузки; выписки по счёту и кредитным картам в любое время загружаются на максимальной скорости, и мгновенно получается общая картина.\n\nПодобно сопоставлению формата данных в файле, в процессе загрузки выполняется умная классификация операций, расходов и доходов, загружаемых из файла. После умной классификации пользователь может изменить классификации на одну из существующего списка. Все эти классификации сохраняются в обучаемой памяти. При каждой следующей загрузке эта память считывается.\n\nЗавершение загрузки. Что вы видите? Годовая страница счёта, годовая раскладка. Таблица баланса, остаток, таблица загруженных операций, классифицированных по темам.' },
    ...
    { heading: 'Панель управления', body: 'Взгляд направо приводит нас к панели управления сайта. Панель управления всегда видна с правой стороны.\n\nКаждый из элементов панели управления предназначен для локального отображения или перехода на другую страницу. Все эти элементы подробно описаны далее в этом документе.' },
  ...
  de: [
    ...
    { heading: 'Erste Schritte', body: 'Sie haben auf den Eingangsbildschirm geklickt und die Anwendung betreten. Was sehen Sie? Was sollten Sie tun?\n\nUm ein Budget zu verwalten, müssen Sie zunächst die Daten laden. Was sind die Möglichkeiten zum Laden. Es gibt mehrere Ladewege. Während des Ladevorgangs erhalten Sie Anleitungen und Meldungen.\n\nWenn Sie im Voraus Dateien zum Laden vorbereitet haben – xls-, xlsx-, csv-Dateien –, sind Sie bereit zum Laden. Das Lademenü im Bedienfeld ermöglicht Ihnen Folgendes: Laden einer einzelnen Datei, Laden eines Ordners mit allen darin enthaltenen Dateien mit einem automatischen Klick, Laden des Dateiordners mit einem halbautomatischen Klick, das heißt, Sie erhalten eine Meldung zu einer Datei und können wählen, ob Sie sie laden möchten oder nicht.\n\nDer Ladevorgang gliedert sich in zwei Phasen:\nPhase 1 ist, wenn die Anwendung zum ersten Mal auf eine unbekannte Ladedatei trifft. In diesem Moment läuft ein intelligenter Algorithmus, an dessen Ende der Fingerabdruck der Datei ermittelt wird – eine exakte Zuordnung der Dateidaten.\nPhase 2 sind alle folgenden Ladevorgänge; Konto- und Kreditkartenauszüge werden jederzeit mit Höchstgeschwindigkeit geladen und es wird sofort ein Gesamtbild erstellt.\n\nÄhnlich wie bei der Zuordnung des Datenformats in der Datei wird während des Ladevorgangs eine intelligente Klassifizierung der aus der Datei geladenen Vorgänge, Ausgaben und Einnahmen durchgeführt. Nach der intelligenten Klassifizierung kann der Nutzer Klassifizierungen in eine aus der bestehenden Liste ändern. All diese Klassifizierungen werden im lernenden Gedächtnis gespeichert. Bei jedem weiteren Laden wird dieses Gedächtnis gelesen.\n\nEnde des Ladevorgangs. Was sehen Sie? Jährliche Kontoseite, Jahresübersicht. Saldotabelle, verbleibendes Guthaben, Tabelle der geladenen Transaktionen, nach Themen klassifiziert.' },
    ...
    { heading: 'Bedienfeld', body: 'Ein Blick nach rechts bringt uns zum Bedienfeld der Website. Das Bedienfeld ist immer auf der rechten Seite sichtbar.\n\nJedes der Elemente im Bedienfeld dient dazu, eine lokale Anzeige darzustellen oder zu einer anderen Seite zu wechseln. Alle diese Elemente werden im weiteren Verlauf dieses Dokuments detailliert beschrieben.' },
  ...
  fr: [
    ...
    { heading: 'Premiers pas', body: "Vous avez cliqué sur l'écran d'entrée et avez accédé à l'application. Que voyez-vous ? Que devez-vous faire ?\n\nPour gérer un budget, vous devez d'abord charger les données. Quelles sont les façons de charger. Il existe plusieurs parcours de chargement. Pendant le processus de chargement, vous recevrez des instructions et des messages.\n\nSi vous avez préparé à l'avance des fichiers à charger — des fichiers xls, xlsx, csv —, tout est prêt pour le chargement. Le menu de chargement du panneau de contrôle vous permet ce qui suit : chargement d'un seul fichier, chargement d'un dossier avec tous ses fichiers en un clic automatique, chargement du dossier de fichiers en un clic semi-automatique, c'est-à-dire que vous recevrez un message concernant un fichier et pourrez choisir de le charger ou non.\n\nLe processus de chargement se divise en deux étapes :\nL'étape 1, c'est lorsque l'application rencontre pour la première fois un fichier de chargement inconnu. À ce moment, un algorithme intelligent s'exécute, à l'issue duquel l'empreinte du fichier est obtenue — un mappage exact des données du fichier.\nL'étape 2, ce sont tous les chargements suivants ; les relevés de compte et de carte de crédit, à tout moment, se chargent à vitesse maximale et un instantané immédiat est obtenu.\n\nDe même que le mappage du format des données dans le fichier, pendant le processus de chargement une classification intelligente des opérations, dépenses et revenus chargés depuis le fichier est effectuée. Après la classification intelligente, l'utilisateur peut changer les classifications pour l'une de la liste existante. Toutes ces classifications sont enregistrées dans la mémoire apprise. À chaque autre chargement, cette mémoire est lue.\n\nFin du chargement. Que voyez-vous ? Page de compte annuelle, présentation annuelle. Tableau de solde, solde restant, tableau des transactions chargées, classées par sujet." },
    ...
    { heading: 'Panneau de contrôle', body: "Un regard vers la droite nous amène au panneau de contrôle du site. Le panneau de contrôle est toujours visible du côté droit.\n\nChacun des éléments du panneau de contrôle sert à afficher quelque chose localement ou à passer à une autre page. Tous ces éléments sont détaillés plus loin dans ce document." },
    { heading: 'Côté du panneau de contrôle', body: "Que vous utilisiez la main droite ou la main gauche, vous pouvez cliquer sur le bouton droit ou gauche du panneau de contrôle, et le panneau de contrôle passera d'un côté à l'autre." },
  ...
  es: [
    ...
    { heading: 'Primeros pasos', body: 'Hizo clic en la pantalla de entrada y entró en la aplicación. ¿Qué ve? ¿Qué debe hacer?\n\nPara gestionar un presupuesto, primero debe cargar los datos. Cuáles son las formas de cargar. Hay varias rutas de carga. Durante el proceso de carga recibirá indicaciones y mensajes.\n\nSi preparó de antemano archivos para cargar —archivos xls, xlsx, csv—, todo está listo para cargar. El menú de carga del panel de control le permite lo siguiente: cargar un solo archivo, cargar una carpeta con todos sus archivos con un clic automático, cargar la carpeta de archivos con un clic semiautomático, es decir, recibirá un mensaje sobre un archivo y podrá elegir si cargarlo o no.\n\nEl proceso de carga se divide en dos etapas:\nLa etapa 1 es cuando la aplicación se encuentra por primera vez con un archivo de carga desconocido. En ese momento se ejecuta un algoritmo inteligente, al final del cual se obtiene la huella del archivo, un mapeo exacto de los datos del archivo.\nLa etapa 2 son todas las cargas siguientes; los extractos de cuenta y de tarjeta de crédito, en cualquier momento, se cargan a máxima velocidad y se obtiene una instantánea inmediata.\n\nDe manera similar al mapeo del formato de datos en el archivo, durante el proceso de carga se realiza una clasificación inteligente de las operaciones, gastos e ingresos cargados del archivo. Tras la clasificación inteligente, el usuario puede cambiar las clasificaciones a una de la lista existente. Todas estas clasificaciones se guardan en la memoria aprendida. En cada carga posterior, esta memoria se lee.\n\nFin de la carga. ¿Qué ve? Página de cuenta anual, disposición anual. Tabla de saldo, saldo restante, tabla de las transacciones cargadas, clasificadas por tema.' },
    ...
    { heading: 'Panel de control', body: 'Una mirada hacia la derecha nos lleva al panel de control del sitio. El panel de control siempre está visible en el lado derecho.\n\nCada uno de los elementos del panel de control sirve para mostrar algo localmente o pasar a otra página. Todos estos elementos se detallan más adelante en este documento.' },
    { heading: 'Lado del panel de control', body: 'Tanto si usa la mano derecha como la izquierda, puede hacer clic en el botón derecho o izquierdo del panel de control, y el panel de control se moverá de un lado a otro.' },
  ...
  ja: [
    ...
    { heading: '使い始める', body: 'ログイン画面をクリックしてアプリケーションに入りました。何が見えますか？何をすべきですか？\n\n予算を管理するには、まずデータを読み込む必要があります。読み込みの方法は何ですか。読み込みにはいくつかの経路があります。読み込みの過程でガイダンスとメッセージを受け取ります。\n\nあらかじめ読み込み用のファイル（xls、xlsx、csv ファイル）を用意していれば、読み込みの準備は完了です。コントロールパネルの読み込みメニューでは次のことができます：単一ファイルの読み込み、フォルダー内のすべてのファイルを1回の自動クリックで読み込み、ファイルフォルダーを半自動クリックで読み込み（つまりファイルごとにメッセージが表示され、読み込むかどうかを選択できます）。\n\n読み込みの過程は2つの段階に分かれます：\n段階1は、アプリケーションが未知の読み込みファイルに初めて遭遇したときです。この瞬間にスマートなアルゴリズムが実行され、その終了時にファイルの指紋、つまりファイルデータの正確なマッピングが得られます。\n段階2は以降のすべての読み込みで、口座明細やクレジット明細はいつでも最高速度で読み込まれ、即座に全体像が得られます。\n\nファイル内のデータ形式のマッピングと同様に、読み込みの過程でファイルから読み込まれた取引・支出・収入のスマートな分類が行われます。スマートな分類の後、ユーザーは分類を既存の分類リストのいずれかに変更できます。これらの分類はすべて学習メモリに保存されます。他の読み込みのたびに、このメモリが読み取られます。\n\n読み込み完了。何が見えますか？年間口座ページ、年間レイアウト。残高表、繰越残高、カテゴリー別に分類された読み込み済み取引の表。' },
    ...
    { heading: 'コントロールパネル', body: '右を見ると、サイトのコントロールパネルにたどり着きます。コントロールパネルは常に右側に表示されます。\n\nコントロールパネルの各項目は、ローカルに何かを表示するか、別のページに移動するための機能を持っています。これらの項目はすべて、この文書のさらに後で詳しく説明されます。' },
  ...
  ar: [
    ...
    { heading: 'الصفحة الرئيسية لإدارة ميزانية المنزل', body: 'نقرتم على الزر من موقع KeyClick وتفتح شاشة البوابة - لفافة مصممة مع تحية ترحيب وعلم اللغة.\n\nاللغة غير مناسبة؟ اختاروا واحدًا من 11 علمًا في أعلى الموقع وسيتم نقلكم فورًا إلى اللغة المختارة. نظام تعدد اللغات هو أحد الوحدات الأساسية للموقع ومنتجاته. يمكنكم التبديل بين اللغات فورًا في أي وقت.\n\nالنقر في أي مكان على الشاشة يغلق شاشة البوابة ويفتح محتوى المشروع.' },
    { heading: 'اختيار اللغة', body: 'أعلى الشاشة ستجدون صفًا من الأعلام - علم لكل من اللغات الـ 11 التي يدعمها البرنامج. النقر على أي علم يبدل فورًا كل البرنامج إلى تلك اللغة - جميع العناوين، جميع التسميات، جميع رسائل النظام. يمكنكم التبديل بين اللغات في أي لحظة، والعودة، دون فقدان أي بيانات.' },
    { heading: 'بدء العمل', body: 'نقرتم على شاشة الدخول ودخلتم إلى التطبيق. ماذا ترون؟ ماذا يجب أن تفعلوا؟\n\nلإدارة الميزانية، يجب أولاً تحميل البيانات. ما هي طرق التحميل. هناك عدة مسارات للتحميل. أثناء عملية التحميل ستتلقون إرشادات ورسائل.\n\nإذا جهّزتم مسبقًا ملفات للتحميل — ملفات xls وxlsx وcsv — فأنتم جاهزون للتحميل. تتيح لكم قائمة التحميل في لوحة التحكم ما يلي: تحميل ملف واحد، تحميل مجلد بكل ملفاته بنقرة تلقائية واحدة، تحميل مجلد الملفات بنقرة شبه تلقائية، أي أنكم ستتلقون رسالة عن الملف ويمكنكم اختيار تحميله أو لا.\n\nتنقسم عملية التحميل إلى مرحلتين:\nالمرحلة 1 هي عندما يواجه التطبيق لأول مرة ملف تحميل غير معروف. في تلك اللحظة تُشغَّل خوارزمية ذكية، وفي نهايتها يتم الحصول على بصمة الملف، أي ربط دقيق لبيانات الملف.\nالمرحلة 2 هي كل عمليات التحميل التالية؛ كشوف الحساب والائتمان في أي وقت تُحمَّل بأقصى سرعة ويتم الحصول على صورة فورية للوضع.\n\nعلى غرار ربط تنسيق البيانات في الملف، يُجرى أثناء عملية التحميل تصنيف ذكي للعمليات والمصروفات والإيرادات المحمّلة من الملف. بعد التصنيف الذكي، يمكن للمستخدم تغيير التصنيفات إلى واحد من قائمة التصنيفات الموجودة. تُحفظ كل هذه التصنيفات في الذاكرة المكتسبة. وفي كل تحميل آخر، تُقرأ هذه الذاكرة.\n\nانتهاء التحميل. ماذا ترون؟ صفحة حساب سنوية، عرض سنوي. جدول الرصيد، الرصيد المتبقي، جدول المعاملات المحملة، مصنفة حسب الموضوع.' },
    ...
    { heading: 'العرض الشهري', body: 'تريدون التعامل مع شهر معين فقط؟ انقروا على العرض الشهري في لوحة التحكم. تفتح صفحة تحتوي على مشتق من شهر معين من الصفحة السنوية. هنا يمكنكم اختيار أي شهر والحصول فورًا على بياناته على الشاشة.' },
    { heading: 'لوحات الرسائل', body: 'أسفل الشاشة، توجد بشكل دائم ثلاث لوحات لرسائل النظام: رسائل جارية، معلومات، وأخطاء محتملة.' },
    { heading: 'لوحة التحكم', body: 'النظر إلى اليمين يقودنا إلى لوحة تحكم الموقع. لوحة التحكم مرئية دائمًا على الجانب الأيمن.\n\nكل عنصر في لوحة التحكم مخصص لعرض شيء محليًا أو الانتقال إلى صفحة أخرى. جميع هذه العناصر مفصلة لاحقًا في هذا المستند.' },
    { heading: 'جانب لوحة التحكم', body: 'سواء كنتم تستخدمون اليد اليمنى أو اليسرى، يمكنكم النقر على الزر الأيمن أو الأيسر في لوحة التحكم، وستنتقل لوحة التحكم من جانب إلى آخر.' },
    ...
    { heading: 'إنهاء العمل', body: 'انتهيتم من العمل وتريدون إغلاق التطبيق؟ انقروا على خروج.' },
    { heading: 'عملية التحميل اليدوي', body: 'تتم عملية التحميل اليدوي من خلال أزرار التحميل في لوحة التحكم. قبل التحميل يمكنكم اختيار تحميل ملف واحد معين - انقروا على ملف؛ تحميل جميع الملفات في مجلد - انقروا على مجلد؛ التحميل التلقائي لجميع الملفات في مجلد - انقروا على تلقائي، حيث ستحصلون على طلب تأكيد لكل ملف. بعد اختيار طريقة التحميل، انقروا على زر تحميل. سيفتح مدير ملفات - اختاروا ملفًا أو مجلدًا، وأكّدوا.' },
    { heading: 'عرض أرقام الحسابات', body: 'بجانب أزرار التحميل لديكم تسمية "رقم الحساب" مع مربعات اختيار. يتم استخراج هذه المعلومات بعد عملية التحميل من البيانات نفسها. اختاروا حسابًا واحدًا أو أكثر ليركز عليها النظام (حتى 4 حسابات مختلفة).' },
    { heading: 'شاشة قاعدة البيانات', body: 'قمتم بتحميل بيانات من صفحات الحساب وتريدون رؤية التحميل الخام كما تم تحميله. انقروا على زر قاعدة البيانات في لوحة التحكم ومرروا إلى العرض المطلوب.' },
    { heading: 'صفحة الفئات', body: 'يمكنكم فتح صفحة الفئات ورؤية جميع الجداول.\n\nإذا لم تكن معاملة معينة في الفئة الصحيحة، انقروا على تعديل، حددوا الفئة الصحيحة، انقروا على تحديث. سيتذكر النظام الاختيار للتحميلات المستقبلية أيضًا.' },
    { heading: 'العرض الرسومي ومخطط الميزانية الدائري', body: 'في لوحة التحكم أمامكم قائمة بالعروض (صفحة الحساب). اختاروا العرض الرسومي. تفتح أمامكم شاشة عرض رسومي سنوي. هنا يمكنكم اختيار أي شيء يخطر ببالكم، أي بند تريدون فحصه عبر الزمن في عرض رسومي.\n\nأنتم في الصفحة الرسومية، تريدون الحصول على فهم أعمق وأيضًا خوض تجربة تقنية مذهلة؟ انقروا على مخطط الميزانية الدائري. في هذا العرض يمكنكم اختيار الشهر المطلوب ورؤية توزيع المصروفات فوق الدخل. في صفحة المخطط الدائري، يتيح لكم الجدول الموجود على اليمين مع المحددات التحكم في شرائح المخطط - خفض أو رفع قيمتها. من خلال ضبط الشرائح يمكنكم الوصول إلى القيم المرغوبة للحصول على التوازن الذي تريدونه.' },
    { heading: 'بطاقات الائتمان', body: 'اذهبوا إلى لوحة التحكم، انقروا على بطاقات الائتمان وستتمكنون من رؤية جميع البطاقات. اختاروا بطاقة واحصلوا على تفصيل دقيق.' },
    { heading: 'التخطيط المستقبلي', body: 'عودوا مرة أخرى إلى لوحة التحكم، انقروا على التخطيط المستقبلي. للتخطيط لعملية، انقروا وستفتح بطاقة تحرير. اختاروا المؤسسة المالية، رقم الحساب، فئة المعاملة، اكتبوا وصف المعاملة، ملاحظة، مبلغًا للخصم أو الإيداع، وعدد الأشهر المعنية. عند الانتهاء انقروا على تحديث.\n\nبعد إدخال العنصر في جدول التخطيط، يمكنكم تكراره أو تغييره. قوموا بذلك عن طريق تحديد الصف والتحرير في نفس البطاقة. اتبعوا التعليمات.\n\nيتم دمج جدول التخطيط المستقبلي، مثل بطاقات الائتمان، بدقة في صفحة الحساب السنوية، متتبعًا الأشهر ذات الصلة. يتم التحديث كل شهر في شهره. لاحظوا أنه في صفحات الحساب المختلفة، توجد خيار لعرض وتحليل البيانات مع أو بدون التخطيط المستقبلي، مع تفصيل كامل لمعاملات بطاقة الائتمان أو ملخصها فقط.' },
    { heading: 'التنقل بين الشاشات', body: 'في لوحة التحكم ستجدون سبعة أزرار تنقلكم بين الشاشات الرئيسية للبرنامج:\n\nسنوي، شهري، فئات، مستقبل، قاعدة بيانات، ائتمان، رسومي\n\nكل واحد منها يفتح شاشة مختلفة، وسأشرح كل واحد منها لاحقًا في الدليل.' },
    { heading: 'تحميل الملفات', body: 'هذا هو المكان الذي تُدخلون فيه إلى البرنامج الملفات التي نزّلتموها من البنك أو من شركة بطاقة الائتمان (عادة ملفات Excel أو CSV). انقروا على زر "تحميل"، واختاروا كيف تريدون التحميل:\n\n•    ملف - تحميل ملف واحد\n•    مجلد - تحميل جميع الملفات الموجودة في مجلد معين دفعة واحدة\n•    تلقائي - يقوم البرنامج بالتحميل بنفسه، دون الحاجة لاختيار كل ملف على حدة\n\nلا داعي للقلق بشأن تحميل نفس الملف مرتين عن طريق الخطأ - يتعرف البرنامج على المعاملات الموجودة لديه بالفعل ولن يضيفها مرة أخرى. هذا يعني أنه يمكنكم بأمان إعادة تحميل ملف قمتم بتحميله من قبل، دون خوف من أن "تتضخم" الأرقام.' },
    { heading: 'الحسابات', body: 'بجانب أزرار التحميل لديكم تسمية "رقم الحساب" مع مربعات اختيار - هنا يمكنكم رؤية واختيار الحسابات المصرفية التي تريدون التركيز عليها (حتى 4 حسابات مختلفة).' },
    { heading: 'إعادة الضبط والبدء من جديد', body: 'إذا أردتم في مرحلة ما البدء من جديد، يوجد زران منفصلان:\n\n•    إعادة ضبط قاعدة البيانات - يحذف جميع المعاملات المحملة\n•    إعادة ضبط الفئات - يحذف الفئات المحددة للمعاملات\n\nوأخيرًا، زر "خروج" للخروج من البرنامج.' },
    { heading: 'الشاشة السنوية', body: 'هذه هي الشاشة الرئيسية للبرنامج، وتسمى "صفحة الحساب السنوية".\n\nهنا ترون جدولًا كبيرًا واحدًا: في الصفوف - جميع فئات المصروفات والدخل الخاصة بكم، وفي الأعمدة - ثلاث سنوات كاملة، شهرًا بشهر. في الصف العلوي من الجدول يظهر ملخص عام - كم دخل، كم خرج، ما الرصيد المرحّل من الفترة السابقة، وما الإجمالي.\n\nإذا أردتم أن تروا بالضبط أي معاملات تقف وراء مبلغ معين - انقروا ببساطة على صف الفئة التي تهمكم، وستفتح لكم الشاشة أيضًا تفاصيلها الكاملة.\n\nفي أعلى الشاشة لديكم بعض الأزرار:\n\n•    تحديث - يحدّث البيانات في الجدول\n•    تصدير - يحفظ الجدول كملف Excel أو PDF، حتى تتمكنوا من حفظه أو طباعته\n•    تحديث\n•    مسح\n\nومفتاحان مهمان سترونهما أيضًا في شاشات أخرى:\n\n•    تضمين المستقبل - يحدد ما إذا كانت المصروفات والإيرادات المستقبلية المخططة (مثل الأوامر الدائمة) مشمولة في الحساب\n•    تضمين بطاقات الائتمان - يحدد ما إذا كانت معاملات بطاقة الائتمان مشمولة في الحساب' },
    { heading: 'الشاشة الشهرية', body: 'تسمى هذه الشاشة "صفحة الحساب الشهرية"، وتمنحكم تكبيرًا لشهر معين يهمكم.\n\nفي الأعلى يمكنكم اختيار سنة وشهر، والنقر على زر "تحديث" لرؤية بيانات تلك الفترة.\n\nما يميز هذه الشاشة هو أنها تجمع لكم في مكان واحد ثمانية جداول مختلفة، بحيث ترون الصورة الكاملة للشهر المختار دفعة واحدة:\n\n•    قائمة المصروفات\n•    ملخص المعاملات حسب الفئة\n•    الإيرادات المستقبلية\n•    المصروفات المستقبلية\n•    حساب الرصيد\n•    الرصيد الشهري\n•    بطاقات الائتمان\n•    الحسابات المصرفية\n\nوهنا أيضًا، المفتاحان "تضمين المستقبل" و"تضمين بطاقات الائتمان" متاحان لكم، إذا أردتم تضمينهما أو حذفهما من الصورة.' },
    { heading: 'شاشة الفئات', body: 'تسمى هذه الشاشة "صفحة الحساب المرتبة حسب الفئات"، وهنا ترون جميع معاملاتكم منظمة حسب الفئة - كل ما ينتمي إلى "الطعام"، كل ما ينتمي إلى "السيارة"، وهكذا.\n\nهذا أيضًا هو المكان الذي يمكنكم فيه تصحيح فئة حددها البرنامج بشكل غير صحيح. يوجهكم البرنامج نفسه بالضبط حول ما يجب فعله: "لتغيير الفئة، انقروا: تعديل، اختيار فئة جديدة، تحديث"\n\nأي - انقروا على تعديل، اختاروا الفئة الصحيحة من القائمة، وانقروا على تحديث. مهم أن تعرفوا: عندما تغيّرون فئة معاملة، يتذكر البرنامج ذلك، بحيث في المرة القادمة التي تحمّلون فيها معاملة مشابهة (بنفس الوصف)، سيصنفها بشكل صحيح من تلقاء نفسه.\n\nوهنا أيضًا، المفتاحان "تضمين المستقبل" و"تضمين بطاقات الائتمان" متاحان لكم.' },
    { heading: 'شاشة قاعدة البيانات', body: 'تسمى هذه الشاشة "قاعدة البيانات"، وهي القائمة الخام والكاملة لكل معاملة تم تحميلها إلى البرنامج - تاريخها، البنك أو شركة بطاقة الائتمان التي جاءت منها، الوصف، المبلغ، الفئة المخصصة لها، والمزيد.\n\nهذا هو المكان الذي يمكنكم التوجه إليه إذا أردتم رؤية "جميع البيانات كما هي"، دون أي تصفية أو تجميع. زر تحديث يحدّث القائمة.' },
    { heading: 'شاشة بطاقات الائتمان', body: 'تسمى هذه الشاشة "بطاقات الائتمان"، وكما تعرضها لكم بنفسها: "أمامكم قائمة بطاقات الائتمان الخاصة بكم، اختاروا واحدة لتفصيل العمليات"\n\nفي الجزء العلوي سترون جدولًا ملخصًا لجميع بطاقات الائتمان الخاصة بكم، شهرًا بشهر، على مدى ثلاث سنوات - تمامًا مثل الشاشة السنوية، لكن مع التركيز على بطاقات الائتمان. عندما تختارون بطاقة معينة، يظهر أدناه جدول إضافي بتفصيل حسب المتاجر التي خصمت منها.\n\nأزرار تحديث وتصدير متاحة هنا أيضًا.' },
    { heading: 'شاشة التخطيط المستقبلي', body: 'تسمى هذه الشاشة "صفحة الحساب المستقبلية"، وهنا تديرون المصروفات والإيرادات التي تعرفونها مسبقًا - أوامر دائمة، دفعات، اشتراكات شهرية، والمزيد.\n\nيوجهكم البرنامج: "بطاقة عملية - اختاروا صفًا أو ابدأوا واحدة جديدة".\n\nلكل عنصر تضيفونه بطاقته الخاصة، مع الحقول التالية:\n\n•    المصدر\n•    الفئة\n•    ملاحظة\n•    الوصف\n•    البنك\n•    الحساب\n•    دخل أو مصروف\n•    تاريخ البدء\n•    عدد الدفعات\n\nبمجرد تحديد تاريخ البدء وعدد الدفعات، يتولى البرنامج توزيع المبلغ إلى الأمام على مدى كل تلك الأشهر، ويدمجه تلقائيًا في جميع الشاشات الأخرى (عند تفعيل مفتاح "تضمين المستقبل").\n\nالإجراءات المتاحة لكم: تحديث، جديد، تعديل، إعادة ضبط، حذف.' },
    { heading: 'شاشة الرسوم البيانية', body: 'تسمى هذه الشاشة "صفحة الحساب بعرض رسومي"، وتمنحكم نفس البيانات - لكن كصورة، وليس كجدول.\n\nيمكنكم الاختيار بين عدة أوضاع عرض: الرصيد، الرصيد المتبقي، المصروفات، وكذلك عرض مركّز حسب الفئة، عنصر واحد، التخطيط المستقبلي، أو بطاقات الائتمان.' },
    { heading: 'مخطط الميزانية الدائري', body: 'داخل شاشة الرسوم البيانية ستجدون أداة خاصة تسمى "مخطط الميزانية الدائري"، والغرض منها هو "تخطيط توازن ميزانية المنزل" - هذه أداة لتنظيم ميزانيتكم بشكل حي: تختارون فترة للعرض (سنة وشهر)، ويمكنكم سحب وتغيير التوزيع بين الفئات ورؤية على الفور كيف يؤثر ذلك على التوازن العام للميزانية.\n\nالأزرار المتاحة: تحديث، إعادة ضبط، تحديث.' },
    { heading: 'لوحة الرسائل', body: 'أسفل الشاشة، طوال عملكم في البرنامج، لديكم لوحة رسائل بثلاثة أقسام:\n\n•    النظام - ما يحدث حاليًا في الخلفية\n•    إرشاد - نصائح وتوجيه\n•    خطأ - إذا فشل شيء ما، ستعرفون ذلك هنا\n\nيمكنكم مسح الرسائل بزر مسح، أو حفظها بزر تصدير.' },
    { heading: 'إدارة ميزانية المنزل M Finance', body: 'تطبيق إدارة ميزانية المنزل هو تاج المشروع. يمكنكم قراءة شرح كامل ومفصل في أدراج المستندات 4 و5 و6 في الأدلة والفيديوهات.\n\nمن خلال التطبيق ستحصلون على نظرة شاملة على نشاطكم المصرفي، الدخل والمصروفات، الرصيد الشهري والسنوي. يمكنكم أيضًا إضافة وتخطيط مصروفات أو إيرادات مستقبلية، بجدول دفعات ذكي.\n\nنقرتم على مفتاح إدارة ميزانية المنزل في لوحة التحكم، ستفتح بوابة التطبيق - صفحة مشابهة لبوابة موقع KeyClick - مع تحية ترحيب باللغة التي اخترتموها.\n\nيقرأ التطبيق ملفات حسابات البنك وبطاقات الائتمان التي نزّلتموها مسبقًا من حسابكم لدى مؤسسة مالية، ويجري تحليلاً معمقًا للعمليات المصرفية في هذه الكشوفات.\n\nتمتد قدرات التطبيق إلى مجموعة متنوعة من العروض، بمقاطع مختلفة وفي أوقات مختلفة، بما في ذلك عروض رسومية فردية.\n\nوهنا لمسة التميز - مخطط ميزانية دائري حي. تُعرض المصروفات كشرائح داخل مخطط الدخل الدائري. آلية ذكية تتيح لكم تغيير قيم الشرائح حتى تحقيق التوازن.' },
  ],
  zh: [
    ...
    { heading: '开始使用', body: '您点击了登录屏幕并进入了应用程序。您看到了什么？您应该做什么？\n\n要管理预算，首先需要加载数据。加载的方式有哪些。有几条加载路径。在加载过程中您会收到指导和消息。\n\n如果您已提前准备好要加载的文件（xls、xlsx、csv 文件），那么您就可以加载了。控制面板中的加载菜单让您可以进行以下操作：加载单个文件，一次自动点击加载某个文件夹及其中所有文件，半自动点击加载文件夹，也就是说，您会收到关于某个文件的消息，并可以选择是否加载它。\n\n加载过程分为两个阶段：\n阶段 1 是应用程序首次遇到不熟悉的加载文件时。此时会运行一个智能算法，算法结束时会得到该文件的指纹，即对文件数据的精确映射。\n阶段 2 是之后的所有加载；账户和信用卡对账单在任何时候都会以最高速度加载，并立即得到状况全貌。\n\n与映射文件中的数据格式类似，在加载过程中会对从文件加载的交易、支出和收入进行智能分类。智能分类后，用户可以将分类更改为现有分类列表中的某一个。所有这些分类都会保存到学习记忆中。每次其他加载时，都会读取此记忆。\n\n加载结束。您看到了什么？年度账户页面，年度布局。余额表、结转余额、按类别分类的已加载交易表。' },
    ...
    { heading: '控制面板', body: '向右看，我们会看到网站的控制面板。控制面板始终显示在右侧。\n\n控制面板上的每个项目都用于本地显示某些内容或转到另一个页面。所有这些项目将在本文档后面详细说明。' },
  ...
  it: [
    ...
    { heading: 'Iniziare', body: "Hai cliccato sulla schermata di accesso e hai aperto l'applicazione. Cosa vedi? Cosa dovresti fare?\n\nPer gestire un bilancio, devi prima caricare i dati. Quali sono i modi per caricare. Ci sono diversi percorsi di caricamento. Durante il processo di caricamento riceverai indicazioni e messaggi.\n\nSe hai preparato in anticipo i file da caricare — file xls, xlsx, csv —, è tutto pronto per il caricamento. Il menu di caricamento nel pannello di controllo ti permette quanto segue: caricamento di un singolo file, caricamento di una cartella con tutti i suoi file con un clic automatico, caricamento della cartella dei file con un clic semiautomatico, cioè riceverai un messaggio su un file e potrai scegliere se caricarlo o no.\n\nIl processo di caricamento si divide in due fasi:\nLa fase 1 è quando l'applicazione incontra per la prima volta un file di caricamento sconosciuto. In quel momento viene eseguito un algoritmo intelligente, al termine del quale si ottiene l'impronta del file, una mappatura esatta dei dati del file.\nLa fase 2 sono tutti i caricamenti successivi; gli estratti conto e delle carte di credito, in qualsiasi momento, si caricano alla massima velocità e si ottiene subito un quadro della situazione.\n\nAnalogamente alla mappatura del formato dei dati nel file, durante il processo di caricamento viene eseguita una classificazione intelligente delle operazioni, spese ed entrate caricate dal file. Dopo la classificazione intelligente, l'utente può cambiare le classificazioni in una dell'elenco esistente. Tutte queste classificazioni vengono salvate nella memoria appresa. A ogni altro caricamento, questa memoria viene letta.\n\nFine del caricamento. Cosa vedi? Pagina del conto annuale, disposizione annuale. Tabella del saldo, saldo residuo, tabella delle transazioni caricate, classificate per argomento." },
    ...
    { heading: 'Pannello di controllo', body: "Uno sguardo verso destra ci porta al pannello di controllo del sito. Il pannello di controllo è sempre visibile sul lato destro.\n\nOgnuno degli elementi del pannello di controllo serve a mostrare qualcosa localmente o a passare a un'altra pagina. Tutti questi elementi sono descritti in dettaglio più avanti in questo documento." },
    { heading: 'Lato del pannello di controllo', body: 'Che tu usi la mano destra o la sinistra, puoi cliccare sul pulsante destro o sinistro nel pannello di controllo, e il pannello di controllo si sposterà da un lato all\'altro.' },
  ...
  hi: [
    ...
    { heading: 'शुरुआत करना', body: 'आपने प्रवेश स्क्रीन पर क्लिक किया और एप्लिकेशन में प्रवेश किया। आप क्या देखते हैं? आपको क्या करना चाहिए?\n\nबजट प्रबंधित करने के लिए, आपको पहले डेटा लोड करना होगा। लोड करने के तरीके क्या हैं। लोड करने के कई मार्ग हैं। लोडिंग प्रक्रिया के दौरान आपको मार्गदर्शन और संदेश प्राप्त होंगे।\n\nयदि आपने पहले से लोड करने के लिए फ़ाइलें तैयार कर ली हैं — xls, xlsx, csv फ़ाइलें —, तो आप लोड करने के लिए तैयार हैं। नियंत्रण पैनल में लोड मेनू आपको निम्नलिखित की अनुमति देता है: एकल फ़ाइल लोड करना, एक स्वचालित क्लिक में किसी फ़ोल्डर की सभी फ़ाइलों सहित उसे लोड करना, अर्ध-स्वचालित क्लिक में फ़ाइल फ़ोल्डर लोड करना, यानी आपको किसी फ़ाइल के बारे में संदेश मिलेगा और आप चुन सकते हैं कि उसे लोड करना है या नहीं।\n\nलोडिंग प्रक्रिया दो चरणों में विभाजित है:\nचरण 1 तब है जब एप्लिकेशन पहली बार किसी अपरिचित लोड फ़ाइल से मिलता है। उस क्षण एक स्मार्ट एल्गोरिदम चलता है, जिसके अंत में फ़ाइल की फ़िंगरप्रिंट प्राप्त होती है, यानी फ़ाइल के डेटा की सटीक मैपिंग।\nचरण 2 सभी अगली लोडिंग है; खाता और क्रेडिट विवरण किसी भी समय अधिकतम गति से लोड होंगे और तुरंत स्थिति का चित्र मिल जाएगा।\n\nफ़ाइल में डेटा प्रारूप की मैपिंग के समान, लोडिंग प्रक्रिया के दौरान फ़ाइल से लोड किए गए लेन-देन, खर्च और आय का स्मार्ट वर्गीकरण किया जाता है। स्मार्ट वर्गीकरण के बाद, उपयोगकर्ता वर्गीकरण को मौजूदा वर्गीकरण सूची में से किसी एक में बदल सकता है। ये सभी वर्गीकरण सीखी हुई मेमोरी में सहेजे जाते हैं। हर दूसरी लोडिंग पर, यह मेमोरी पढ़ी जाती है।\n\nलोडिंग समाप्त। आप क्या देखते हैं? वार्षिक खाता पृष्ठ, वार्षिक लेआउट। शेष तालिका, बकाया शेष, लोड किए गए लेन-देन की तालिका, विषय के अनुसार वर्गीकृत।' },
    ...
    { heading: 'नियंत्रण पैनल', body: 'दाईं ओर देखने से हम साइट के नियंत्रण पैनल पर पहुंचते हैं। नियंत्रण पैनल हमेशा दाईं ओर दिखाई देता है।\n\nनियंत्रण पैनल पर प्रत्येक आइटम स्थानीय रूप से कुछ प्रदर्शित करने या किसी अन्य पृष्ठ पर जाने के लिए है। ये सभी आइटम इस दस्तावेज़ में आगे विस्तार से बताए गए हैं।' },
...
const SITE_GUIDE_SECTIONS: Record<string, GuideSection[]> = {
  he: [
    { heading: 'דף הנחיתה', body: 'נכנסתם לדף הנחיתה, בחרתם שפה, ראיתם, קראתם ואהבתם את דף הנחיתה... הגיע הזמן לצלול לאתר.\nלחצו על התווית: כניסה לאתר KeyClick' },
    { heading: 'דף הבית KeyClick', body: 'לחצתם? זהו, אתם באתר. גליל עם ברכת כניסה ודגל השפה מתגלים לפניכם.\nהשפה לא מתאימה ? בחרו 1 מתוך 11 הדגלים בראש האתר ותועברו מידית לשפה הנבחרת. מערכת ריבוי השפות הוא אחד מיחידות הבסיס של האתר ומוצריו. תוכלו בכל עת לעבור מידית משפה לשפה.' },
    { heading: 'לוח הבקרה', body: 'מבט ימינה מביא אותנו ללוח בקרה של האתר.\nחלק מהפקדים בשלב זה יכללו סרט אדום אשר בו תהיה המילה: נעול". הנעילה נועדה לשמור על פרטיותכם. כניסה מאובטחת לפרויקט תשחרר את הנעילה לשימוש חופשי.\nללקוחות חדשים מומלץ ללחוץ על התווית מדריכים וסרטונים.' },
    { heading: 'שימוש חופשי ללא הרשמה', body: 'בכניסה לאתר, טרם הרישום תוכלו לפתוח את מדריכים וסרטונים ולקבל מושג והנחיות איך להפיק מהמערכת את המיטב.\nעברתם על המדריכים והסרטונים וברצונכם להתחיל להנות מניהול תקציב בית חכם, לחצו על כפתור הכניסה ובצעו רישום מהיר.' },
    { heading: 'כניסה ורישום', body: 'לקוח רשום - אם אתם כבר רשומים במערכת, הכניסו שם ומשפחה, כתובת מייל, סיסמא.\nבמידה ומתגלות שגיאות או חוסר התאמה בפרטים שהזנתם, תקבלו הודעה: לקוח לא קיים.\nלקוח חדש – לחצו על כניסה ובחרו הרשמה.\nכעת מתחיל תהליך קצר של רישום ובחירת תכנית מותאמת אישית.\nבשלב של תקופת הרצה ותקופת ניסיון, השימוש הוא חינם ללא עלות. בתום תקופת ההרצה תצא הודעה מתאימה ללקוחות.' },
    { heading: 'חבילות שימוש במערכת', body: 'בתום תקופת ההרצה או תקופת הניסיון , קיבלתם על כך הודעת מערכת, גמרתם תקופת השימוש החינמי ומגיע הזמן לבחור תכנית חבילת שימוש. לחצו על תווית דף אישי, לחצו על תווית השינוי וייפתח טופס שינוי תכנית.\nקיימות 3 תכניות ממומנות: מנוי שנתי, מנוי חודשי, מנוי לפי שימוש.' },
    { heading: 'דף אישי', body: 'הדף האישי שלכם יכיל את הפרטים האישיים הבסיסיים שלכם וכן את תכנית הרכישה המועדפת שבחרתם, כולל התקופה, זמן התחלה וזמן סיום.\nלבחירת תכנית רכישה מתאימה בחרו על כפתור השינוי בדף האישי. לאחר הבחירה לחצו על כפתור עדכן.' },
    { heading: 'תזכורות', body: 'בחרתם תכנית רכישה, זמן ההתחלה וזמן הסיום נטענים מיד ליומן מובנה.\nלהצגת היומן לחצו על מתג תזכורות בפאנל הבקרה.\nיש לכם צורך בתזכורות פרטיות כלשהן, יומן התזכורות הזה יכול גם לשמש צרכים פרטיים.\nהתזכורת מפעילה התראות הבאות. כל כניסה לאתר תוצג תזכורת אשר הגיעה זמנה.' },
    { heading: 'משוב', body: 'גלשתם באתר, הפעלתם אפליקציות ויש לכם רצון להחליף כמה מילים עם המערכת, בכל נושא, בכל בעיה או סתם בא לכם לשלוח משוב. לחצו על התווית משוב.\nברצונכם לפתוח שיחה חדשה, לחצו על הודעה חדשה בראש הדף ורשמו את הודעתכם בסעיף: דבר הלקוח.\nהדף כולל גם את הודעת המערכת, אשר מכניס אתכם לעניינים ומציג לכם חדשות חמות.\nאם אהבתם או חלילה לא כל כך את הפרויקט, לפניכם שתי שורות של דירוג: דרוג האתר ודירוג ניהול תקציב בית.\nסיימתם לדרג, זהו, לחצו לשליחה.\nשימו לב שלכל הודעה יש סימוכין, שמשמת כחותמת ייחודית לכל הודעה, דבר המקל על ניהול ההודעות והשיוך של התשובות מהמערכת.\nבעמוד המשוב נוצרת טבלת הודעות ויש באפשרותכם הודעות קודמות.\nתשובת המערכת תתוסף להודעה ששלחתם במקומה המיועד בתחתית הדף.\nכל תשובה של המערכת שמורה באותו הטופס בסעיף תשובת המערכת.\nלהודעה נוספת עליכם ללחוץ על כפתור הודעה חדשה. כל הודעה בטופס חדש.' },
    ...
    { heading: 'ניהול תקציב בית M Finance', body: 'אפליקציית ניהול תקציב בית היא גולת הכותרת של הפרויקט. הסבר מלא ופורט תוכלו לקרוא במגירת המסמכים 4,5,6 במדריכים וסרטונים.\nבאמצעות האפליקציה תקבלו מבט כולל על הפעולות הבנקאיות שלכם, הכנסות והוצאות, מאזן חודשי ושנתי. תוכלו להוסיף ולתכנן הוצאות או הכנסות עתידיות, בפריסת תשלומים חכמה.\nלחצתם על מתג ניהול תקציב בית בפאנל הבקרה, יפתח שער האפליקציה, דף הדומה לשער האתר KeyClick, עם ברכת כניסה בשפה שבחרתם.\nהאפליקציה קוראת קבצי חשבונות בנק וכרטיסי אשראי אשר הורדתם מבעוד מועד מחשבונכם במוסד פיננסי ועורכת ניתוח מעמיק לפעולות הבנקאיות בדפים אלה.\nיכולות האפליקציה למגוון תצוגות בחתכים שונים ובזמנים שונים, כולל הצגות גרפיות פרטניות.\nוהנה הדובדובן שבקצפת – עוגת תקציב חיה. ההוצאות מוצגות כפרוסות בתוך עוגת ההכנסות. מנגנון חכם מאפשר לכם לשנות את ערכי הפרוסות עד לקבלת מאזן.' },
    { heading: 'מיפוי וזכרון נלמד', body: 'קובץ עו"ש או אשראי, בטעינה ראשונה עובר מיפוי חכם ונשמר בזכרון נלמד. מרגע זה כל הקבצים במיפוי דומה נטענים בשניות בודדות.\nכל הפעולות, ההוצאות וההכנסות הנטענות מקבצים אלו, עוברים סיווג חכם. המשתמש יכול לשנות סיווג במהלך העבודה. כל אותם סיווגים נשמרים בזכרון נלמד ויופעלו בכל הטעינות הבאות.' },
  ],
  en: [
    ...
    { heading: 'Free Use Without Registration', body: 'Upon entering the site, before registering, you can open Guides and Videos to get an idea and guidance on how to get the best out of the system.\nWent over the guides and videos and want to start enjoying smart home budget management? Click the login button and perform a quick registration.' },
    ...
    { heading: 'Mapping and learned memory', body: 'A checking or credit-card file goes through smart mapping on its first load and is saved to learned memory. From then on, all files with a similar mapping load in just seconds.\nEvery transaction, expense and income loaded from these files goes through smart categorization. The user can change a category while working. All those categorizations are saved to learned memory and applied on every future load.' },
  ],
  ru: [
    ...
    { heading: 'Свободное использование без регистрации', body: 'При входе на сайт, ещё до регистрации, можно открыть «Руководства и видео», чтобы получить представление и рекомендации, как получить от системы максимум.\nПросмотрели руководства и видео и хотите начать пользоваться умным управлением семейным бюджетом? Нажмите на кнопку входа и выполните быструю регистрацию.' },
    ...
    { heading: 'Маппинг и обучаемая память', body: 'Файл текущего счёта или кредитной карты при первой загрузке проходит умный маппинг и сохраняется в обучаемую память. С этого момента все файлы с похожим маппингом загружаются за считанные секунды.\nВсе операции, расходы и доходы из этих файлов проходят умную категоризацию. Пользователь может менять категорию по ходу работы. Все эти категории сохраняются в обучаемую память и применяются при всех последующих загрузках.' },
  ],
  de: [
    ...
    { heading: 'Freie Nutzung ohne Registrierung', body: 'Beim Betreten der Website können Sie schon vor der Registrierung Anleitungen und Videos öffnen, um sich einen Eindruck zu verschaffen und Hinweise zu erhalten, wie Sie das Beste aus dem System herausholen.\nHaben Sie die Anleitungen und Videos durchgesehen und möchten Sie nun das intelligente Haushaltsbudget-Management genießen? Klicken Sie auf die Anmelde-Schaltfläche und führen Sie eine schnelle Registrierung durch.' },
    ...
    { heading: 'Mapping und lernendes Gedächtnis', body: 'Eine Giro- oder Kreditkartendatei durchläuft beim ersten Laden ein intelligentes Mapping und wird im lernenden Gedächtnis gespeichert. Ab diesem Moment werden alle Dateien mit ähnlichem Mapping in wenigen Sekunden geladen.\nAlle aus diesen Dateien geladenen Vorgänge, Ausgaben und Einnahmen durchlaufen eine intelligente Kategorisierung. Der Nutzer kann die Kategorie während der Arbeit ändern. All diese Kategorien werden im lernenden Gedächtnis gespeichert und bei jedem weiteren Laden angewendet.' },
  ],
  fr: [
    ...
    { heading: 'Mappage et mémoire apprise', body: "Un fichier de compte courant ou de carte de crédit passe par un mappage intelligent lors du premier import et est enregistré dans la mémoire apprise. Dès lors, tous les fichiers au mappage similaire s'importent en quelques secondes.\nToutes les opérations, dépenses et recettes importées de ces fichiers passent par une catégorisation intelligente. L'utilisateur peut changer de catégorie en cours de travail. Toutes ces catégories sont enregistrées dans la mémoire apprise et appliquées à chaque import suivant." },
  ],
  es: [
    ...
    { heading: 'Mapeo y memoria aprendida', body: 'Un archivo de cuenta corriente o de tarjeta de crédito pasa por un mapeo inteligente en su primera carga y se guarda en la memoria aprendida. Desde ese momento, todos los archivos con un mapeo similar se cargan en pocos segundos.\nTodas las operaciones, gastos e ingresos cargados desde esos archivos pasan por una categorización inteligente. El usuario puede cambiar la categoría durante el trabajo. Todas esas categorías se guardan en la memoria aprendida y se aplican en todas las cargas siguientes.' },
  ],
  ja: [
    ...
    { heading: '登録なしでの自由な利用', body: 'サイトに入ると、登録前でも「ガイドと動画」を開いて、システムを最大限に活用する方法についてのヒントと説明を得ることができます。\nガイドと動画を確認し、スマートな家計管理を楽しみ始めたいですか？ログインボタンをクリックして、簡単な登録を行ってください。' },
    ...
    { heading: 'マッピングと学習メモリ', body: '普通預金やクレジットカードのファイルは、初回読み込み時にスマートなマッピングを行い、学習メモリに保存されます。それ以降、同じようなマッピングのファイルはすべて数秒で読み込まれます。\nこれらのファイルから読み込まれたすべての取引・支出・収入は、スマートな分類にかけられます。作業中に分類を変更することもできます。それらの分類はすべて学習メモリに保存され、以降の読み込みごとに適用されます。' },
  ],
  ar: [
    { heading: 'صفحة الهبوط', body: 'دخلتم إلى صفحة الهبوط، اخترتم لغة، رأيتم، قرأتم وأعجبتكم صفحة الهبوط... حان الوقت للغوص في الموقع.\nاضغطوا على العبارة: الدخول إلى موقع KeyClick' },
    { heading: 'الصفحة الرئيسية لـ KeyClick', body: 'ضغطتم؟ ها أنتم في الموقع. تظهر أمامكم لفافة مع تحية ترحيب وعلم اللغة.\nاللغة غير مناسبة؟ اختاروا 1 من بين 11 علمًا في أعلى الموقع وسيتم نقلكم فورًا إلى اللغة المختارة. نظام تعدد اللغات هو أحد الوحدات الأساسية للموقع ومنتجاته. يمكنكم الانتقال فورًا من لغة إلى أخرى في أي وقت.' },
    { heading: 'لوحة التحكم', body: 'نظرة نحو اليمين تأخذنا إلى لوحة تحكم الموقع.\nبعض عناصر التحكم في هذه المرحلة ستتضمن شريطًا أحمر تظهر عليه كلمة: "مقفل". يهدف القفل إلى حماية خصوصيتكم. الدخول الآمن إلى المشروع سيزيل القفل للاستخدام الحر.\nيُنصح العملاء الجدد بالضغط على عبارة الأدلة والفيديوهات.' },
    { heading: 'استخدام حر دون تسجيل', body: 'عند الدخول إلى الموقع، وقبل التسجيل، يمكنكم فتح الأدلة والفيديوهات للحصول على فكرة وإرشادات حول كيفية الاستفادة القصوى من النظام.\nهل اطلعتم على الأدلة والفيديوهات وترغبون في البدء بالاستمتاع بإدارة ذكية لميزانية المنزل؟ اضغطوا على زر الدخول وقوموا بتسجيل سريع.' },
    { heading: 'الدخول والتسجيل', body: 'عميل مسجل - إذا كنتم مسجلين بالفعل في النظام، أدخلوا الاسم الأول واسم العائلة، عنوان البريد الإلكتروني، وكلمة المرور.\nإذا تم اكتشاف أخطاء أو عدم تطابق في التفاصيل التي أدخلتموها، ستظهر الرسالة: العميل غير موجود.\nعميل جديد – اضغطوا على دخول واختاروا تسجيل.\nتبدأ الآن عملية قصيرة من التسجيل واختيار خطة مخصصة.\nخلال فترة الإطلاق وفترة التجربة، يكون الاستخدام مجانيًا دون أي تكلفة. في نهاية فترة الإطلاق، سيتم إرسال إشعار مناسب للعملاء.' },
    { heading: 'باقات استخدام النظام', body: 'في نهاية فترة الإطلاق أو فترة التجربة، ستتلقون إشعار نظام بذلك — انتهت فترة استخدامكم المجانية وحان وقت اختيار خطة باقة استخدام. اضغطوا على عبارة الصفحة الشخصية، اضغطوا على عبارة التغيير، وسيُفتح نموذج تغيير الخطة.\nتوجد 3 خطط مدفوعة: اشتراك سنوي، اشتراك شهري، اشتراك حسب الاستخدام.' },
    { heading: 'الصفحة الشخصية', body: 'ستحتوي صفحتكم الشخصية على بياناتكم الشخصية الأساسية بالإضافة إلى خطة الشراء المفضلة التي اخترتموها، بما في ذلك الفترة، وقت البدء ووقت الانتهاء.\nلاختيار خطة شراء مناسبة، اضغطوا على زر التغيير في الصفحة الشخصية. بعد الاختيار، اضغطوا على زر التحديث.' },
    { heading: 'التذكيرات', body: 'بمجرد اختيار خطة الشراء، يتم تحميل وقت البدء ووقت الانتهاء فورًا إلى تقويم مدمج.\nلعرض التقويم، اضغطوا على مفتاح التذكيرات في لوحة التحكم.\nإذا كنتم بحاجة إلى أي تذكيرات خاصة، يمكن لتقويم التذكيرات هذا أن يخدم أيضًا الاحتياجات الخاصة.\nيقوم التذكير بتفعيل إشعارات قادمة. سيعرض كل دخول إلى الموقع تذكيرًا حان وقته.' },
    { heading: 'الملاحظات', body: 'تصفحتم الموقع، شغّلتم تطبيقات، ولديكم رغبة في تبادل بضع كلمات مع النظام — حول أي موضوع، أي مشكلة، أو ببساطة تشعرون برغبة في إرسال ملاحظات. اضغطوا على عبارة الملاحظات.\nهل ترغبون في بدء محادثة جديدة؟ اضغطوا على رسالة جديدة في أعلى الصفحة واكتبوا رسالتكم في قسم رسالة العميل.\nتتضمن الصفحة أيضًا رسالة النظام، التي تُطلعكم على المستجدات وتعرض لكم آخر الأخبار.\nسواء أحببتم المشروع أو، لسوء الحظ، لم يعجبكم كثيرًا، أمامكم صفان للتقييم: تقييم الموقع وتقييم إدارة ميزانية المنزل.\nهل انتهيتم من التقييم؟ ها هو، اضغطوا للإرسال.\nلاحظوا أن لكل رسالة رقم مرجعي، يُستخدم كختم فريد لكل رسالة، مما يسهّل إدارة الرسائل وربط الردود من النظام.\nفي صفحة الملاحظات يتم إنشاء جدول رسائل، ويمكنكم الاطلاع على رسائل سابقة.\nستُضاف رسالة النظام إلى الرسالة التي أرسلتموها، في المكان المخصص لها أسفل الصفحة.\nيتم حفظ كل رد من النظام في نفس النموذج، في قسم رد النظام.\nلإرسال رسالة أخرى، يجب الضغط على زر رسالة جديدة. كل رسالة في نموذج جديد.' },
    ...
    { heading: 'إدارة ميزانية المنزل M Finance', body: 'تطبيق إدارة ميزانية المنزل هو جوهرة تاج المشروع. يمكنكم قراءة شرح كامل ومفصل في أدراج الأدلة 4 و5 و6 ضمن الأدلة والفيديوهات.\nمن خلال التطبيق، تحصلون على نظرة شاملة على عملياتكم المصرفية، الدخل والمصروفات، الرصيد الشهري والسنوي. يمكنكم أيضًا إضافة وتخطيط مصروفات أو دخل مستقبلي، بجدولة دفعات ذكية.\nهل ضغطتم على مفتاح إدارة ميزانية المنزل في لوحة التحكم؟ ستُفتح بوابة التطبيق — صفحة شبيهة ببوابة موقع KeyClick، مع تحية ترحيب باللغة التي اخترتموها.\nيقرأ التطبيق ملفات الحسابات المصرفية وبطاقات الائتمان التي قمتم بتحميلها مسبقًا من حسابكم لدى مؤسسة مالية، ويجري تحليلاً معمقًا للعمليات المصرفية في تلك الملفات.\nيوفر التطبيق مجموعة متنوعة من العروض، بتصنيفات وفترات زمنية مختلفة، بما في ذلك عروض رسومية فردية.\nوها هي القشدة على الوجه – كعكة ميزانية حية. تُعرض المصروفات كشرائح داخل كعكة الدخل. تتيح لكم آلية ذكية تغيير قيم الشرائح حتى تحقيق التوازن.' },
    { heading: 'الربط والذاكرة المكتسبة', body: 'ملف الحساب الجاري أو بطاقة الائتمان يمرّ عند التحميل الأول بعملية ربط ذكية ويُحفظ في الذاكرة المكتسبة. من تلك اللحظة، تُحمّل كل الملفات ذات الربط المشابه خلال ثوانٍ معدودة.\nكل العمليات والنفقات والإيرادات المحمّلة من هذه الملفات تمرّ بتصنيف ذكي. يمكن للمستخدم تغيير التصنيف أثناء العمل. تُحفظ كل هذه التصنيفات في الذاكرة المكتسبة وتُطبَّق في كل عمليات التحميل التالية.' },
  ],
  zh: [
    ...
    { heading: '无需注册的免费使用', body: '进入网站后，在注册之前，您就可以打开"指南与视频"，了解并获取如何充分利用系统的说明。\n您已浏览过指南与视频，想开始享受智能家庭预算管理？请点击登录按钮并进行快速注册。' },
    ...
    { heading: '映射与学习记忆', body: '支票或信用卡文件在首次加载时会经过智能映射并保存到学习记忆。此后，所有映射相似的文件都能在几秒内加载完成。\n从这些文件加载的所有交易、支出和收入都会经过智能分类。用户可在工作过程中更改分类。所有这些分类都会保存到学习记忆，并在此后每次加载时应用。' },
  ],
  it: [
    { heading: 'Pagina di destinazione', body: "Hai aperto la pagina di destinazione, hai scelto una lingua, hai visto, letto e ti è piaciuta la pagina di destinazione... è ora di tuffarsi nel sito.\nClicca sull'etichetta: Entra nel sito KeyClick" },
    ...
    { heading: 'Mappatura e memoria appresa', body: "Un file di conto corrente o di carta di credito passa per una mappatura intelligente al primo caricamento e viene salvato nella memoria appresa. Da quel momento tutti i file con una mappatura simile si caricano in pochi secondi.\nTutte le operazioni, le spese e le entrate caricate da questi file passano per una categorizzazione intelligente. L'utente può cambiare categoria durante il lavoro. Tutte queste categorie vengono salvate nella memoria appresa e applicate a ogni caricamento successivo." },
  ],
  hi: [
    ...
    { heading: 'बिना पंजीकरण के मुफ़्त उपयोग', body: 'साइट में प्रवेश करते ही, पंजीकरण से पहले भी, आप गाइड और वीडियो खोलकर यह जान सकते हैं और यह मार्गदर्शन पा सकते हैं कि सिस्टम से अधिकतम लाभ कैसे उठाया जाए।\nक्या आपने गाइड और वीडियो देख लिए हैं और अब स्मार्ट गृह बजट प्रबंधन का आनंद लेना शुरू करना चाहते हैं? लॉगिन बटन पर क्लिक करें और त्वरित पंजीकरण करें।' },
    ...
    { heading: 'मैपिंग और सीखी हुई मेमोरी', body: 'चालू खाते या क्रेडिट कार्ड की फ़ाइल पहली बार लोड होने पर स्मार्ट मैपिंग से गुज़रती है और सीखी हुई मेमोरी में सहेज ली जाती है। उसके बाद, मिलती-जुलती मैपिंग वाली सभी फ़ाइलें कुछ ही सेकंड में लोड हो जाती हैं।\nइन फ़ाइलों से लोड हुए सभी लेन-देन, खर्च और आय स्मार्ट वर्गीकरण से गुज़रते हैं। उपयोगकर्ता काम के दौरान वर्गीकरण बदल सकता है। ये सभी वर्गीकरण सीखी हुई मेमोरी में सहेजे जाते हैं और आगे हर लोड पर लागू होते हैं।' },
  ],
}

const GUIDES_MUSIC_LABEL: Record<string, string> = {
  he: 'בורר מוסיקת רקע', en: 'Background music selector', ru: 'Выбор фоновой музыки', de: 'Hintergrundmusik wählen',
  fr: 'Choix de la musique de fond', es: 'Selector de música de fondo', ja: 'BGMの選択', ar: 'اختيار موسيقى الخلفية',
  zh: '背景音乐选择', it: 'Selettore musica di sottofondo', hi: 'पृष्ठभूमि संगीत चयन',
}

function GuidesMusicBar({ langCode }: { langCode: string }) {
...
// טקסט בין ** ל-** בגוף סעיף מדריך מוצג מודגש
function renderGuideBody(text: string) {
  return text.split(/\*\*(.+?)\*\*/g).map((part, i) => i % 2 === 1 ? <strong key={i}>{part}</strong> : part)
}

function GuidesDetailPage({ lang, category, drawerLabel, contentTitle, contentDesc, sections, imageSrc, imageWidth, imageHeight, videoSrc, pageId, navButtons, onNavigate, onChangeLang }: { lang: typeof languages[0]; category: string; drawerLabel: string; contentTitle: string; contentDesc: string; sections?: GuideSection[]; imageSrc?: string; imageWidth?: number; imageHeight?: number; videoSrc?: string; pageId?: string; navButtons?: { label: string; page: string }[]; onNavigate?: (page: string) => void; onChangeLang?: (i: number) => void }) {
    ...
    <div className="furniture" style={{ flex: 1, width: isColLayout ? undefined : '100%', minWidth: isColLayout ? 0 : undefined, minHeight: 0 }}>
      ...
      <div className="cabinet" style={{ width: cabinetWidth, maxWidth: isColLayout ? '100%' : undefined, flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0, ...(isColLayout ? {} : { maxHeight: 'calc(100vh - 320px)' }) }}>
        <div ref={fsRef} style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', position: 'relative', background: '#eef1f9' }}>
          ...
          {!videoSrc && !(sections && sections.length > 0) && (
            <div className="tray-row" style={{ direction: isRTL ? 'rtl' : 'ltr' }}><strong>{contentTitle}</strong></div>
          )}
          {videoSrc ? (
            ...
            (() => {
              const chapters = sections.filter(s => s.heading && !s.sub)
              const ledes = sections.filter(s => !s.heading)
              let chNo = 0
              const img = (s: GuideSection) => s.image && (
              ...
              return (
                <div className={isFs ? 'guide-doc gd-fs' : 'guide-doc'} style={{ direction: isRTL ? 'rtl' : 'ltr', textAlign: isRTL ? 'right' : 'left', maxWidth: isFs ? 1000 : undefined, marginInline: isFs ? 'auto' : undefined }}>
                  {category && <div className="gd-kicker">{category}</div>}
                  <h2 className="gd-title">{contentTitle}</h2>
                  <div className="gd-title-rule" />
                  {ledes.map((s, i) => <p key={'l' + i} className="gd-lede">{s.body}</p>)}
                  {chapters.length >= 4 && (
                    <nav className="gd-toc" aria-label="תוכן העניינים">
                      <h4>תוכן העניינים</h4>
                      <ol>
                        {chapters.map((s, i) => (
                          <li key={i}>
                            <button type="button" onClick={() => document.getElementById('gd-ch-' + (i + 1))?.scrollIntoView({ behavior: 'smooth', block: 'start' })}>
                              <span className="gd-n">{i + 1}</span><span className="gd-t">{s.heading}</span>
                            </button>
                          </li>
                        ))}
                      </ol>
                  ...
                  {sections.map((s, i) => {
                    ...
                    if (s.sub) return (
                      <div key={i}>{img(s)}<div className="gd-sub">{s.heading}</div><p className="gd-body">{renderGuideBody(s.body)}</p></div>
                    )
                    chNo += 1
                    const n = chNo
                    return (
                      <section key={i} className="gd-ch" id={'gd-ch-' + n}>
                        {img(s)}
                        <div className="gd-ch-head"><div className="gd-ch-num">{n}</div><h3 className="gd-ch-title">{s.heading}</h3></div>
                        <p className="gd-body">{renderGuideBody(s.body)}</p>
                      </section>
                    )
                  })}
...
function PersonalPage({ user, lang, onNavigate, onUserUpdate, onDbg }: { user: UserRecord | null; lang: typeof languages[0]; onNavigate: (page: string) => void; onUserUpdate: (user: UserRecord) => void; onDbg: (func: string, msg: string) => void }) {
  ...
  const [notifSound, setNotifSound] = useState<string>(() => { try { return localStorage.getItem('kc_notif_sound') || 'ding' } catch { return 'ding' } })
  const [notifCustomName, setNotifCustomName] = useState<string>(() => { try { return localStorage.getItem('kc_notif_custom_name') || '' } catch { return '' } })
  const notifFileRef = useRef<HTMLInputElement>(null)
  function saveNotifSound(v: string) { setNotifSound(v); try { localStorage.setItem('kc_notif_sound', v) } catch { /* */ } }
  function onNotifFile(e: React.ChangeEvent<HTMLInputElement>) {
    const f = e.target.files?.[0]; if (!f) return
    if (f.size > 900_000) { alert(lang.profile.notifSoundTooBig); e.target.value = ''; return }
    const r = new FileReader()
    r.onload = () => {
      try {
        localStorage.setItem('kc_notif_custom', String(r.result))
        localStorage.setItem('kc_notif_custom_name', f.name)
        setNotifCustomName(f.name)
        saveNotifSound('custom')
      } catch { alert(lang.profile.notifSoundTooBig) }
    }
    r.readAsDataURL(f)
    e.target.value = ''
  }
  ...
  return (
    <div style={outerWrap}>
      ...
      <div style={cardBox}>
        ...
        {/* Notification sound */}
        <div style={{ ...secBox, padding: '22px 20px 18px', marginBottom: '20px' }}>
          <span style={secLabel}>{p.notifSound}</span>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
            <select value={notifSound} onChange={e => saveNotifSound(e.target.value)} style={{ fontSize: '15px', padding: '6px 10px', border: '1px solid #003399', borderRadius: '6px', background: '#fff' }}>
              <option value="ding">🔔 1</option>
              <option value="chime">🔔 2</option>
              <option value="beep">🔔 3</option>
              <option value="knock">🔔 4</option>
              {notifCustomName && <option value="custom">🎵 {notifCustomName}</option>}
              <option value="off">{p.notifSoundOff}</option>
            </select>
            <button onClick={() => playNotifSound(notifSound)} disabled={notifSound === 'off'} style={{ fontSize: '14px', padding: '6px 16px', background: notifSound === 'off' ? '#889' : '#003399', color: '#FFD700', border: 'none', borderRadius: '6px', cursor: notifSound === 'off' ? 'default' : 'pointer', fontWeight: 'bold' }}>▶ {p.notifSoundTest}</button>
            <button onClick={() => notifFileRef.current?.click()} style={{ fontSize: '14px', padding: '6px 16px', background: '#fff', color: '#003399', border: '1px solid #003399', borderRadius: '6px', cursor: 'pointer', fontWeight: 'bold' }}>{p.notifSoundUpload}</button>
            <input ref={notifFileRef} type="file" accept="audio/*" onChange={onNotifFile} style={{ display: 'none' }} />
          </div>
          <div style={{ color: '#6670a0', fontSize: '12px', marginTop: '8px' }}>{p.notifSoundHint}</div>
        </div>
