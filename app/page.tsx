...
const FINANCE_GUIDE_SECTIONS: Record<string, GuideSection[]> = {
  ...
  en: [
    ...
    { heading: 'Preparing and Downloading Files for Loading', body: 'The only thing to prepare before using the app is to download account statements from the bank and account statements from the credit card company. The app supports Excel files (xls, xlsx) and csv.\n\nNote that each checking-account statement must be downloaded into one file, each file for one account. The same applies to credit cards: a separate file for each credit card.\n\nHow to download an account statement from the bank or credit card company to your computer:\n1. Open a web browser\n2. Sign in to your account\n3. If it is a checking account, choose a period\n4. If it is a credit card, choose the card and billing month\n5. Click Save, choose a format, Excel or CSV\n6. Click to download\n7. Choose a folder for the download\n8. Sign out of the account\n9. Remember the file location for the loading step' },
  ...
  ru: [
    ...
    { heading: 'Подготовка и загрузка файлов для импорта', body: 'Единственное, что нужно подготовить перед использованием приложения, — это скачать выписки со счёта в банке и выписки от компании кредитных карт. Приложение поддерживает файлы Excel (xls, xlsx) и csv.\n\nОбратите внимание: каждую выписку по текущему счёту нужно скачивать в один файл, каждый файл — для одного счёта. То же касается кредитных карт: отдельный файл для каждой карты.\n\nКак скачать выписку из банка или от компании кредитных карт на компьютер:\n1. Откройте веб-браузер\n2. Войдите в свой аккаунт\n3. Если это текущий счёт, выберите период\n4. Если это кредитная карта, выберите карту и месяц выставления счёта\n5. Нажмите «Сохранить», выберите формат — Excel или CSV\n6. Нажмите для загрузки\n7. Выберите папку для загрузки\n8. Выйдите из аккаунта\n9. Запомните расположение файлов для последующей загрузки' },
  ...
  de: [
    ...
    { heading: 'Vorbereitung und Herunterladen von Dateien zum Laden', body: 'Das Einzige, was Sie vor der Nutzung der App vorbereiten müssen, ist das Herunterladen von Kontoauszügen von der Bank und Abrechnungen vom Kreditkartenunternehmen. Die App unterstützt Excel-Dateien (xls, xlsx) und csv.\n\nBeachten Sie: Jeder Girokonto-Auszug muss in eine Datei heruntergeladen werden, jede Datei für ein Konto. Das Gleiche gilt für Kreditkarten: eine separate Datei für jede Kreditkarte.\n\nSo laden Sie einen Kontoauszug von der Bank oder dem Kreditkartenunternehmen auf den Computer herunter:\n1. Öffnen Sie einen Webbrowser\n2. Melden Sie sich bei Ihrem Konto an\n3. Wenn es ein Girokonto ist, wählen Sie einen Zeitraum\n4. Wenn es eine Kreditkarte ist, wählen Sie die Karte und den Abrechnungsmonat\n5. Klicken Sie auf Speichern, wählen Sie ein Format, Excel oder CSV\n6. Klicken Sie zum Herunterladen\n7. Wählen Sie einen Ordner für den Download\n8. Melden Sie sich vom Konto ab\n9. Merken Sie sich den Speicherort der Dateien für das spätere Laden' },
  ...
  fr: [
    ...
    { heading: 'Préparation et téléchargement des fichiers à charger', body: "La seule chose à préparer avant d'utiliser l'application est de télécharger les relevés de compte de la banque et les relevés de la société de cartes de crédit. L'application prend en charge les fichiers Excel (xls, xlsx) et csv.\n\nÀ noter : chaque relevé de compte courant doit être téléchargé dans un seul fichier, chaque fichier pour un compte. Il en va de même pour les cartes de crédit : un fichier séparé pour chaque carte.\n\nComment télécharger un relevé de compte depuis la banque ou la société de cartes de crédit vers l'ordinateur :\n1. Ouvrez un navigateur web\n2. Connectez-vous à votre compte\n3. S'il s'agit d'un compte courant, choisissez une période\n4. S'il s'agit d'une carte de crédit, choisissez la carte et le mois de facturation\n5. Cliquez sur Enregistrer, choisissez un format, Excel ou CSV\n6. Cliquez pour télécharger\n7. Choisissez un dossier pour le téléchargement\n8. Déconnectez-vous du compte\n9. Retenez l'emplacement des fichiers pour l'étape de chargement" },
  ...
  es: [
    ...
    { heading: 'Preparación y descarga de archivos para cargar', body: 'Lo único que hay que preparar antes de usar la aplicación es descargar los extractos de cuenta del banco y los extractos de la compañía de tarjetas de crédito. La aplicación admite archivos de Excel (xls, xlsx) y csv.\n\nTen en cuenta que cada extracto de cuenta corriente debe descargarse en un archivo, cada archivo para una cuenta. Lo mismo ocurre con las tarjetas de crédito: un archivo separado para cada tarjeta.\n\nCómo descargar un extracto de cuenta del banco o de la compañía de tarjetas de crédito al ordenador:\n1. Abre un navegador web\n2. Inicia sesión en tu cuenta\n3. Si es una cuenta corriente, elige un período\n4. Si es una tarjeta de crédito, elige la tarjeta y el mes de facturación\n5. Haz clic en Guardar, elige un formato, Excel o CSV\n6. Haz clic para descargar\n7. Elige una carpeta para la descarga\n8. Cierra la sesión de la cuenta\n9. Recuerda la ubicación de los archivos para el paso de carga' },
  ...
  ja: [
    ...
    { heading: '読み込み用ファイルの準備とダウンロード', body: 'アプリを使う前に準備する必要があるのは、銀行から口座明細を、クレジットカード会社から明細をダウンロードすることだけです。アプリは Excel ファイル（xls、xlsx）と csv に対応しています。\n\n注意：普通預金口座の明細は1つのファイルにダウンロードし、1ファイルにつき1口座とします。クレジットカードも同様で、カードごとに別々のファイルにします。\n\n銀行またはクレジットカード会社から口座明細をパソコンにダウンロードする方法：\n1. ウェブブラウザを開く\n2. 自分のアカウントにログインする\n3. 普通預金口座の場合は期間を選ぶ\n4. クレジットカードの場合はカードと請求月を選ぶ\n5. 「保存」をクリックし、形式（Excel または CSV）を選ぶ\n6. ダウンロードをクリックする\n7. ダウンロード先のフォルダーを選ぶ\n8. アカウントからログアウトする\n9. 読み込みのためにファイルの場所を覚えておく' },
  ...
  ar: [
    ...
    { heading: 'تحضير الملفات وتنزيلها للتحميل', body: 'الشيء الوحيد الذي يجب تحضيره قبل استخدام التطبيق هو تنزيل كشوف الحساب من البنك وكشوف الحساب من شركة بطاقات الائتمان. يدعم التطبيق ملفات Excel (xls, xlsx) و csv.\n\nملاحظة: يجب تنزيل كل كشف حساب جارٍ في ملف واحد، كل ملف لحساب واحد. وينطبق الأمر نفسه على بطاقات الائتمان: ملف منفصل لكل بطاقة.\n\nكيفية تنزيل كشف حساب من البنك أو شركة بطاقات الائتمان إلى الحاسوب:\n1. افتح متصفح إنترنت\n2. سجّل الدخول إلى حسابك\n3. إذا كان حسابًا جاريًا فاختر فترة\n4. إذا كانت بطاقة ائتمان فاختر البطاقة وشهر الفوترة\n5. اضغط على حفظ، واختر الصيغة، Excel أو CSV\n6. اضغط للتنزيل\n7. اختر مجلدًا للتنزيل\n8. سجّل الخروج من الحساب\n9. تذكّر موقع الملفات لخطوة التحميل' },
  ...
  zh: [
    ...
    { heading: '准备并下载待导入的文件', body: '使用应用之前唯一需要准备的，就是从银行下载账户对账单，从信用卡公司下载对账单。应用支持 Excel 文件（xls、xlsx）和 csv。\n\n请注意：每份活期账户对账单要下载为一个文件，每个文件对应一个账户。信用卡也一样，每张信用卡单独一个文件。\n\n如何将银行或信用卡公司的账户对账单下载到电脑：\n1. 打开网页浏览器\n2. 登录你的账户\n3. 如果是活期账户，选择时间段\n4. 如果是信用卡，选择卡片和账单月份\n5. 点击保存，选择格式，Excel 或 CSV\n6. 点击下载\n7. 选择下载文件夹\n8. 退出账户\n9. 记住文件位置以便后续导入' },
  ...
  it: [
    ...
    { heading: 'Preparazione e download dei file da caricare', body: "L'unica cosa da preparare prima di usare l'applicazione è scaricare gli estratti conto dalla banca e gli estratti dalla società delle carte di credito. L'applicazione supporta file Excel (xls, xlsx) e csv.\n\nNota che ogni estratto del conto corrente deve essere scaricato in un file, ogni file per un conto. Lo stesso vale per le carte di credito: un file separato per ogni carta.\n\nCome scaricare un estratto conto dalla banca o dalla società delle carte di credito sul computer:\n1. Apri un browser web\n2. Accedi al tuo account\n3. Se è un conto corrente, scegli un periodo\n4. Se è una carta di credito, scegli la carta e il mese di fatturazione\n5. Fai clic su Salva, scegli un formato, Excel o CSV\n6. Fai clic per scaricare\n7. Scegli una cartella per il download\n8. Esci dall'account\n9. Ricorda la posizione dei file per la fase di caricamento" },
  ...
  hi: [
    ...
    { heading: 'लोड करने के लिए फ़ाइलें तैयार करना और डाउनलोड करना', body: 'ऐप का उपयोग करने से पहले तैयार करने की एकमात्र चीज़ है — बैंक से खाता विवरण और क्रेडिट कार्ड कंपनी से विवरण डाउनलोड करना। ऐप Excel फ़ाइलों (xls, xlsx) और csv का समर्थन करता है।\n\nध्यान दें: प्रत्येक चालू खाता विवरण को एक फ़ाइल में डाउनलोड करना चाहिए, प्रत्येक फ़ाइल एक खाते के लिए। यही बात क्रेडिट कार्ड पर भी लागू होती है: प्रत्येक क्रेडिट कार्ड के लिए अलग फ़ाइल।\n\nबैंक या क्रेडिट कार्ड कंपनी से खाता विवरण अपने कंप्यूटर पर कैसे डाउनलोड करें:\n1. वेब ब्राउज़र खोलें\n2. अपने खाते में साइन इन करें\n3. यदि यह चालू खाता है, तो अवधि चुनें\n4. यदि यह क्रेडिट कार्ड है, तो कार्ड और बिलिंग माह चुनें\n5. सहेजें पर क्लिक करें, प्रारूप चुनें, Excel या CSV\n6. डाउनलोड करने के लिए क्लिक करें\n7. डाउनलोड के लिए फ़ोल्डर चुनें\n8. खाते से साइन आउट करें\n9. लोड करने के अगले चरण के लिए फ़ाइलों का स्थान याद रखें' },
