      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <aside style={{ width: '140px', background: '#1a1a1a', color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'stretch', flexShrink: 0 }}>
          ...
          <div style={{ position: 'relative', width: '120px', margin: '6px auto 4px', overflow: 'hidden', borderRadius: '10px' }}>
            ...
            <button onClick={() => { if (isLoggedInExplicit) return; mfChainRef.current = true; setActivePage('mf-login') }}
