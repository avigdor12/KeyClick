    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', fontFamily: 'Arial, sans-serif', overflow: 'hidden', position: 'relative' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <div ref={sidebarContentRef} style={{ width: '100%', minHeight: sidebarAvailable, transform: `scale(${sidebarScale})`, transformOrigin: 'top center', position: 'absolute', top: 0, left: 0, display: 'flex', flexDirection: 'column' }}>
          ...
          {/* 5. שרותים בנקאיים — הכפתור הוסר (השירות מוקפא). הרכיב BankingPage והניתוב page==='4' נשארים כקוד לא-נגיש. */}
  ...
  return (
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', fontFamily: 'Arial, sans-serif', overflow: 'hidden' }}>
      ...
      <div ref={mainContentRef} style={{ flex: 1, minWidth: 0, overflow: 'auto', padding: view === 'messages' ? 0 : view === 'statistics' ? '0 20px 16px' : '16px 20px', ...GRANITE_BG }}>
        ...
        {/* ❄ הוקפא 10.09.2026 — תצוגת "מוסדות פיננסיים" בלוח הניהול. הנושא כולו מוקפא. הכפתור שמפעיל view='banking' נשאר בלוח המעבדה. נשמר, לא נמחק. ראה Doc/AI Claude Code/Removal_Banking_Services.html */}
        {view === 'banking' && (
...
const SITE_GUIDE_SECTIONS: Record<string, GuideSection[]> = {
  ...
  ar: [
    ...
    { heading: 'استخدام حر دون تسجيل', body: 'عند الدخول إلى الموقع، وقبل التسجيل، يمكنك فتح الأدلة والفيديوهات للحصول على فكرة وإرشادات حول كيفية الاستفادة القصوى من النظام.\nهل اطلعت على الأدلة والفيديوهات وترغب في البدء بالاستمتاع بإدارة ذكية لميزانية المنزل؟ اضغط على زر الدخول وقم بتسجيل سريع.' },
...
// ❄ הוקפא 10.09.2026 — פאנל "מוסדות פיננסיים" בלוח הניהול. נושא השירותים הבנקאיים הישירים כולו מוקפא. נשמר כקוד, לא נמחק. ראה Doc/AI Claude Code/Removal_Banking_Services.html
...
// ❄ הוקפא 10.09.2026 — דף השירותים הבנקאיים הישירים (page==='4'). הנושא כולו מוקפא (החלטת אביגדור). קוד לא-נגיש, נשמר ולא נמחק. אין להרחיב. ראה Doc/AI Claude Code/Removal_Banking_Services.html
