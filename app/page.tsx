              ...
              <table style={{ borderCollapse: 'collapse', fontSize: 13, direction: 'ltr', whiteSpace: 'nowrap' }}>
                <thead>
                  <tr style={{ background: '#e8eaf6' }}>
                    <th colSpan={8} style={{ padding: '4px 10px', border: '1px solid #a0a8c0', color: '#003399', fontWeight: 'bold', textAlign: 'center' }}>General</th>
                    <th colSpan={6} style={{ padding: '4px 10px', border: '1px solid #a0a8c0', color: '#003399', fontWeight: 'bold', textAlign: 'center' }}>M Finance</th>
                  </tr>
                  <tr style={{ background: '#e8eaf6' }}>
                    {['ID','Created','Name','Email','Language','Currency','IP','Last IP'].map(h => (
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '15px', marginBottom: '22px' }}>
            <thead>
              <tr style={{ background: '#e8eaf6' }}>
                ...
                <th style={{ ...thStyle, textAlign: 'center' }}><div>{p.price}</div><select value={selectedCurrency} onChange={e => handleCurrencyChange(e.target.value)} style={{ fontSize: '11px', border: '1px solid #aab', borderRadius: '3px', padding: '1px 2px', marginTop: '2px', background: '#f0f2ff', cursor: 'pointer', color: '#003399', fontWeight: 'bold', outline: 'none' }}>{CURRENCIES.map(c => <option key={c.code} value={c.code}>{c.symbol} {c.name}</option>)}</select></th>
