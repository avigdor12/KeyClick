...
function InstitutionsAdminPanel({ lang }: { lang: typeof languages[0] }) {
  ...
  const BANKS: Record<string, string[]> = {
    ...
    'ישראל': ['בנק הפועלים', 'בנק לאומי', 'בנק דיסקונט', 'בנק מזרחי', 'הבנק הבינלאומי', 'בנק יהב', 'בנק ברקליס', 'בנק ירושלים', 'ישראכרט', 'כאל', 'מקס', 'אמריקן אקספרס'],
  ...
  const ISRAEL_BANK_LATIN: Record<string, string> = {
    ...
    'בנק מזרחי': 'Mizrahi Bank', 'הבנק הבינלאומי': 'The International Bank', 'בנק יהב': 'Bank Yahav',
