...
const FINANCE_GUIDE_SECTIONS: Record<string, GuideSection[]> = {
  he: [
    ...
    { heading: 'לוח הבקרה', body: 'מבט ימינה מביא אותנו ללוח בקרה של האתר. לוח הבקרה מצד ימין תמיד גלוי בפניך,\n\nכל אחד מהפריטים על לוח הבקרה נועד למלא פונקציה של הצגה מקומית או מעבר לדף אחר. בהמשך במסמך זה יפורטו כל הפריטים הללו.', image: { src: '/guides/mfinance-control-panel-he.jpg', width: 131, height: 812 } },
  ...
  en: [
    ...
    { heading: 'Control Panel', body: "Looking to the right brings us to the site's control panel. The control panel is always visible on the right side.\n\nEach of the items on the control panel serves to display something locally or move to another page. All these items are detailed further in this document.", image: { src: '/guides/mfinance-control-panel-en.jpg', width: 136, height: 816 } },
  ...
  ru: [
    ...
    { heading: 'Панель управления', body: 'Взгляд направо приводит нас к панели управления сайта. Панель управления всегда видна с правой стороны.\n\nКаждый из элементов панели управления предназначен для локального отображения или перехода на другую страницу. Все эти элементы подробно описаны далее в этом документе.', image: { src: '/guides/mfinance-control-panel-ru.jpg', width: 132, height: 814 } },
  ...
  de: [
    ...
    { heading: 'Bedienfeld', body: 'Ein Blick nach rechts bringt uns zum Bedienfeld der Website. Das Bedienfeld ist immer auf der rechten Seite sichtbar.\n\nJedes der Elemente im Bedienfeld dient dazu, eine lokale Anzeige darzustellen oder zu einer anderen Seite zu wechseln. Alle diese Elemente werden im weiteren Verlauf dieses Dokuments detailliert beschrieben.', image: { src: '/guides/mfinance-control-panel-de.jpg', width: 131, height: 814 } },
  ...
  fr: [
    ...
    { heading: 'Panneau de contrôle', body: "Un regard vers la droite nous amène au panneau de contrôle du site. Le panneau de contrôle est toujours visible du côté droit.\n\nChacun des éléments du panneau de contrôle sert à afficher quelque chose localement ou à passer à une autre page. Tous ces éléments sont détaillés plus loin dans ce document.", image: { src: '/guides/mfinance-control-panel-fr.jpg', width: 136, height: 824 } },
  ...
  es: [
    ...
    { heading: 'Panel de control', body: 'Una mirada hacia la derecha nos lleva al panel de control del sitio. El panel de control siempre está visible en el lado derecho.\n\nCada uno de los elementos del panel de control sirve para mostrar algo localmente o pasar a otra página. Todos estos elementos se detallan más adelante en este documento.', image: { src: '/guides/mfinance-control-panel-es.jpg', width: 131, height: 813 } },
  ...
  ja: [
    ...
    { heading: 'コントロールパネル', body: '右を見ると、サイトのコントロールパネルにたどり着きます。コントロールパネルは常に右側に表示されます。\n\nコントロールパネルの各項目は、ローカルに何かを表示するか、別のページに移動するための機能を持っています。これらの項目はすべて、この文書のさらに後で詳しく説明されます。', image: { src: '/guides/mfinance-control-panel-ja.jpg', width: 138, height: 817 } },
  ...
  ar: [
    ...
    { heading: 'لوحة التحكم', body: 'النظر إلى اليمين يقودنا إلى لوحة تحكم الموقع. لوحة التحكم مرئية دائمًا على الجانب الأيمن.\n\nكل عنصر في لوحة التحكم مخصص لعرض شيء محليًا أو الانتقال إلى صفحة أخرى. جميع هذه العناصر مفصلة لاحقًا في هذا المستند.', image: { src: '/guides/mfinance-control-panel-ar.jpg', width: 134, height: 817 } },
  ...
  zh: [
    ...
    { heading: '控制面板', body: '向右看，我们会看到网站的控制面板。控制面板始终显示在右侧。\n\n控制面板上的每个项目都用于本地显示某些内容或转到另一个页面。所有这些项目将在本文档后面详细说明。', image: { src: '/guides/mfinance-control-panel-zh.jpg', width: 135, height: 812 } },
  ...
  it: [
    ...
    { heading: 'Pannello di controllo', body: "Uno sguardo verso destra ci porta al pannello di controllo del sito. Il pannello di controllo è sempre visibile sul lato destro.\n\nOgnuno degli elementi del pannello di controllo serve a mostrare qualcosa localmente o a passare a un'altra pagina. Tutti questi elementi sono descritti in dettaglio più avanti in questo documento.", image: { src: '/guides/mfinance-control-panel-it.jpg', width: 135, height: 822 } },
  ...
  hi: [
    ...
    { heading: 'नियंत्रण पैनल', body: 'दाईं ओर देखने से हम साइट के नियंत्रण पैनल पर पहुंचते हैं। नियंत्रण पैनल हमेशा दाईं ओर दिखाई देता है।\n\nनियंत्रण पैनल पर प्रत्येक आइटम स्थानीय रूप से कुछ प्रदर्शित करने या किसी अन्य पृष्ठ पर जाने के लिए है। ये सभी आइटम इस दस्तावेज़ में आगे विस्तार से बताए गए हैं।', image: { src: '/guides/mfinance-control-panel-hi.jpg', width: 136, height: 812 } },
