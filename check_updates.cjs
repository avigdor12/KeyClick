...
client.connect().then(() =>
  client.query("UPDATE system_DB_Records SET value='KeyClick: M Solution Group|ver 05.00  27.06.2026 11.40' WHERE key='KeyClick_Site_Version_Id' RETURNING value")
