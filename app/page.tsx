...
export const languages = [
  ...
  { code: 'ar', flag: 'סעודיה',  name: 'العربية',  welcome: 'أهلاً وسهلاً',
    ...
    profile: { fullName: 'الاسم الكامل', email: 'البريد الإلكتروني', ip: 'IP', language: 'اللغة', country: 'الدولة', notifSound: 'صوت الإشعار', notifSoundOff: 'إيقاف', notifSoundTest: 'تشغيل', notifSoundUpload: 'رفع ملف...', notifSoundHint: 'يتم التحكم بمستوى الصوت من خلال مازج Windows. يُحفظ الملف في هذا المتصفح فقط.', notifSoundTooBig: 'الملف كبير جدًا (بحد أقصى 900 كيلوبايت)', plan: 'الخطة', planStart: 'بداية الخطة', planEnd: 'نهاية الخطة', unlimited: 'بلا حدود', comingSoon: 'قريباً', choosePlan: 'اختر خطة', close: '✕ إغلاق', loginRequired: 'تسجيل الدخول مطلوب', login: 'دخول', products: 'المنتجات', change: 'تغيير',
...
const FINANCE_GUIDE_SECTIONS: Record<string, GuideSection[]> = {
  he: [
    ...
    { heading: 'דף הבית של ניהול תקציב בית', body: 'לחצת על הכפתור מאתר KeyClick ונפתחת תצוגת שער הכניסה, גליל מסוגנן עם ברכת כניסה ודגל השפה.\n\nהשפה לא מתאימה ? בחרו 1 מתוך 11 הדגלים בראש האתר ותועבר מידית לשפה הנבחרת. מערכת ריבוי השפות הוא אחד מיחידות הבסיס של האתר ומוצריו. ניתן בכל עת לעבור מידית משפה לשפה.\n\nלחיצה על המסך תסגור את מסך השער ותפתח את תכולת הפרויקט.' },
    { heading: 'בחירת שפה', body: 'בראש המסך תמצאו שורת דגלים - דגל לכל אחת מ-11 השפות הנתמכות בתוכנה. לחיצה על דגל כלשהו מחליפה מיידית את כל התוכנה לאותה שפה - כל הכותרות, כל התוויות, כל הודעות המערכת. אפשר לעבור בין שפות בכל רגע, ולחזור בחזרה, בלי לאבד שום נתון.' },
    { heading: 'התחלת עבודה', body: 'לחצת על מסך הכניסה ונכנסת לאפליקציה. מה רואים? מה עליך לעשות?\n\nעל מנת לנהל תקציב יש קודם כל לטעון את הנתונים. מה הדרכים לטעינה. מספר מסלולים לטעינה. בתהליך הטעינה תקבלו הנחיות והודעות.\n\nאם הכנת מראש קבצים לטעינה, קבצי xls, xlsx, csv, אז אתם מוכנים לטעינה. תפריט טעינה אשר בלוח הבקרה מאפשר לך את הדברים הבאים: טעינת קובץ בודד, טעינת תיקיה עם כל הקבצים בה בלחיצה אחת אוטומטית, טעינת תיקיית הקבצים בלחיצה חצי אוטומטית, כלומר תקבלו הודעה על קובץ ותוכלו לבחור אם לטעון אותו או לא.\n\nתהליך הטעינה מתחלק לשני שלבים:\nשלב 1 הוא כאשר האפליקציה פוגשת לראשונה קובץ טעינה לא מוכר. ברגע זה מופעל אלגוריתם חכם, אשר בסיומו מתקבלת טביעת האצבע של הקובץ, מיפוי מדויק של נתוני הקובץ.\nשלב 2 הוא כל הטעינות הבאות, דפי חשבון ואשראי בכל זמן שהוא, יטענו במהירות שיא ותתקבל תמונת מצב מידית.\n\nבדומה למיפוי פורמט הנתונים בקובץ, בתהליך הטעינה מתבצע סיווג חכם של הפעולות, הוצאות והכנסות הנטענות מהקובץ. לאחר הסיווג החכם, ניתנת למשתמש לשנות סיווגים לאחד מרשימת הסיווגים הקיימת. כל הסיווגים הללו נשמרים בזכרון נלמד. בכל טעינה אחרת, הזכרון הזה נקרא.\n\nסיום הטעינה. מה רואים? דף חשבון שנתי, פריסה שנתית. טבלת מאזן, יתרה, טבלת הפעולות שנטענו, מסווגות לפי נושאים.' },
    ...
    { heading: 'תצוגה חודשית', body: 'ברצונך לטפל רק בחודש מסוים, לחצו בלוח הבקרה על תצוגה חודשית. יפתח בפניך דף הכולל נגזרת של חודש מסוים מהדף השנתי. כאן אפשר לבחור כל חודש ומיד תקבלו את הנתונים למסך.' },
    ...
    { heading: 'צד לוח הבקרה', body: 'אם אתם ימניים או שמאליים, אפשר ללחוץ על כפתור ימין או שמאל בלוח הבקרה ולוח הבקרה יעבור מצד לצד.' },
    ...
    { heading: 'סיום עבודה', body: 'סיימת עבודה וברצונך לסגור את האפליקציה. לחצו צא.' },
    { heading: 'תהליך טעינה ידנית', body: 'תהליך טעינה ידנית מייושם על ידי כפתורי הטעינה בלוח הבקרה. לפני הטעינה אפשר לבחור לטעון קובץ אחד מסויים, בחרו קובץ, טעינת כל הקבצים בתיקיה, לחצו תיקיה, טעינה אוטומוית של כל הקבצים בתיקיה, לחצו אוטומטי או בכל קובץ תתקבל בקשת אישור. בחרת אופן הטעינה, לחצו על כפתור טען. ייפתח בפניך מנהל קבצים, בחרו קובץ או תיקיה ואשרו.' },
    { heading: 'תצוגת מספרי חשבון', body: 'לצד כפתורי הטעינה יש לך תווית "מס. חשבון" עם תיבות סימון . המידע הזה נשלף לאחר תהליך הטעינה מתוך הנתונים. בחרו חשבון אחד או יותר להתמקדות המערכת (עד 4 חשבונות שונים).' },
    { heading: 'מסך המסד', body: 'טענת נתונים מתוך דפי חשבון ורוצים לראות את הטעינה הגולמית איך שזה נטען, לחצו על כפתור המסד בלוח הבקרה וגלגלו להצגה הרצויה.' },
    ...
    { heading: 'תצוגה גרפית ועוגת התקציב', body: 'בפאנל הבקרה יש בפניך רשימה של תצוגות (דף חשבון). בחרו תצוגה גרפית. מסך תצוגה שנתית גרפית תפתח בפניך. כאן אפשר לבחור כל מה שעולה על דעתך, כל סעיף אותו תרצו לבחון לאורך הזמן בהצגה גרפית.\n\nאתם בדף הגרפי, ברצונכם לקבל מושג יותר עמוק וגם לחוות חוויה טכנולוגית מדהימה, לחצו על עוגת התקציב. בתצוגה זו תוכלו לבחור את החודש הרצוי ולראות את הפריסה של ההוצאות על גבי ההכנסות. בדף העוגה, הטבלה מימין עם הבוררים מאפשרת לך לשלוט על פרוסות העוגה. להוריד או להעלות את ערכה. בביצוע הוויסות של הפרוסות אפשר להגיע לערכים רצויים לקבלת האיזון הרצוי לך.' },
    { heading: 'כרטיסי אשראי', body: 'עברו ללוח הבקרה, לחצו על כרטיסי האשראי ותוכלו לראות את כל הכרטיסים. בחרו כרטיס ותקבלו פירוט.' },
    { heading: 'תכנון עתידי', body: 'עברו שוב ללוח הבקרה, לחצו על תכנון עתידי. לתכנון פעולות לחצו ותפתח כרטיסייית עריכה. בחרו את המוסד הפיננסי, מספר החשבון, את סיווג הפעולה, רשמו תיאור הפעולה, הערה, סכום לחיוב או לזכות וכן בכמה חודשים מדובר. בסיום לחצו על עדכון.\n\nלאחר שהכנסת את הפעולה לטבלת התכנון, אפשר לשכפל אותה או לשנות אותה. זאת על ידי בחירת השורה ועריכה באותה הכרטיסיה. עקוב אחר ההוראות.\n\nטבלת התכנון העתידי, כמו כרטיסי האשראי, ישולבו במדויק בדף החשבון השנתי, במעקב החודשים הרלוונטיים. עדכון בכל חודש בחודשו. שימו לב שבדפי החשבון השונים, יש ברירה של הצגה וניתוח הנתונים עם תכנון עתידי או בלי, עם פרוט פעולות האשראי או רק הסיכום שלהם.' },
    { heading: 'מעבר בין המסכים', body: 'בפאנל הבקרה תמצאו שבעה כפתורים שמעבירים אותך בין המסכים המרכזיים של התוכנה:\n\nשנתי, חודשי, סווג, עתידי, מסד, אשראי, גרפי\n\nכל אחד מהם פותח מסך אחר, ואני אסביר על כל אחד מהם בהמשך המדריך.' },
    { heading: 'טעינת קבצים', body: 'זה המקום שבו מכניסים לתוכנה את הקבצים שהורדת מהבנק או מחברת האשראי (בדרך כלל קבצי Excel או CSV). לחצו על הכפתור "טען", ובחרו איך לטעון:\n\n•    קובץ - טעינת קובץ בודד\n•    תיקיה - טעינת כל הקבצים שנמצאים בתיקייה מסוימת בבת אחת\n•    אוטומטי - התוכנה טוענת בעצמה, ללא צורך לבחור כל קובץ בנפרד\n\nאין צורך לדאוג לגבי טעינה כפולה של אותו קובץ בטעות - התוכנה מזהה תנועות שכבר קיימות אצלה ולא תוסיף אותן פעמיים. זה אומר שאפשר בלב שקט לטעון שוב קובץ שכבר טענת בעבר, בלי חשש שהמספרים "יתנפחו".' },
    { heading: 'חשבונות', body: 'לצד כפתורי הטעינה יש לך תווית "מס. חשבון" עם תיבות סימון - כאן רואים ואפשר לבחור באילו חשבונות בנק להתמקד (עד 4 חשבונות שונים).' },
    ...
    { heading: 'המסך השנתי', body: 'זהו המסך המרכזי של התוכנה, ונקרא "דף חשבון שנתי".\n\nכאן רואים טבלה גדולה אחת: בשורות - כל קטגוריות ההוצאה וההכנסה שלך, ובעמודות - שלוש שנים שלמות, חודש אחר חודש. בשורה העליונה של הטבלה מופיע לך סיכום כללי - כמה נכנס, כמה יצא, מה היתרה שהצטברה מהתקופה הקודמת, ומה סך הכל.\n\nאם רוצים לראות בדיוק אילו תנועות עומדות מאחורי סכום מסוים - פשוט לחצו על השורה של הקטגוריה שמעניינת אותך, והמסך ייפתח לך גם את הפירוט המלא שלה.\n\nבראש המסך יש לך כמה כפתורים:\n\n•    עידכון - מרענן את הנתונים בטבלה\n•    ייצוא - שומר את הטבלה כקובץ Excel או PDF, כדי שתוכלו לשמור אותה או להדפיס אותה\n•    ריענון\n•    ניקוי\n\nוכן שני מתגים חשובים שתראו גם במסכים נוספים בהמשך:\n\n•    כולל עתידי - קובע אם הוצאות והכנסות מתוכננות לעתיד (למשל הוראות קבע) ייכללו בחישוב\n•    כולל כרטיסי אשראי - קובע אם תנועות כרטיסי האשראי ייכללו בחישוב' },
    { heading: 'המסך החודשי', body: 'המסך הזה נקרא "דף חשבון חודשי", והוא נותן לך זום-אין לחודש ספציפי שמעניין אותך.\n\nלמעלה תוכלו לבחור שנה וחודש, וללחוץ על הכפתור "עדכן" כדי לראות את הנתונים של אותה תקופה.\n\nמה שמיוחד במסך הזה הוא שהוא מרכז עבורך במקום אחד שמונה טבלאות שונות, כך שרואים את כל התמונה של החודש הנבחר בבת אחת:\n\n•    רשימת הוצאות\n•    ריכוז פעולות על פי סיווג\n•    הכנסות עתידיות\n•    הוצאות עתידיות\n•    חישוב יתרה\n•    מאזן חודשי\n•    כרטיסי אשראי\n•    חשבונות בנק\n\nוגם כאן, שני המתגים "כולל עתידי" ו"כולל כרטיסי אשראי" זמינים לך, אם תרצו לכלול או להשמיט אותם מהתמונה.' },
    { heading: 'מסך הסיווגים', body: 'המסך הזה נקרא "דף חשבון ממוין סיווגים", וכאן רואים את כל התנועות שלך מאורגנות לפי קטגוריה - כל מה ששייך ל"מזון", כל מה ששייך ל"רכב", וכן הלאה.\n\nזה גם המקום שבו אפשר לתקן סיווג שהתוכנה קבעה לא נכון. התוכנה עצמה מנחה אותך בדיוק מה לעשות: "שינוי הסווג, לחץ: עריכה, בחירת סווג חדש, עידכון"\n\nכלומר - לחצו על עריכה, בחרו את הקטגוריה הנכונה מהרשימה, ולחצו עידכון. חשוב לדעת: כשמשנים סיווג של תנועה, התוכנה זוכרת את זה, כך שבפעם הבאה שתטענו תנועה דומה (עם אותו תיאור), היא כבר תסווג אותה נכון מעצמה.\n\nוגם כאן זמינים לך שני המתגים "כולל עתידי" ו"כולל כרטיסי אשראי".' },
    { heading: 'מסך המסד', body: 'המסך הזה נקרא "מסד נתונים", וזוהי הרשימה הגולמית והמלאה של כל תנועה ותנועה שנטענה לתוכנה - התאריך שלה, הבנק או חברת האשראי שממנה היא הגיעה, התיאור, הסכום, הסיווג שניתן לה, ועוד.\n\nזה המקום שאליו אפשר לפנות אם רוצים לראות את "כל הנתונים כמו שהם", בלי שום סינון או קיבוץ. כפתור עידכון מרענן את הרשימה.' },
    { heading: 'מסך כרטיסי האשראי', body: 'המסך הזה נקרא "כרטיסי אשראי", וכפי שהוא עצמו מציג לך: "לפניך רשימת כרטיסי האשראי, בחר לפירוט הפעולות"\n\nבחלק העליון תראו טבלה מסכמת של כל כרטיסי האשראי שלך, חודש אחר חודש, לאורך שלוש שנים - בדיוק כמו במסך השנתי, רק ממוקד בכרטיסי אשראי. כשבוחרים כרטיס מסוים, מופיעה לך למטה טבלה נוספת עם פירוט לפי בתי העסק שחייבו אותו.\n\nכפתורי רענון וייצוא זמינים גם כאן.' },
    { heading: 'מסך התכנון העתידי', body: 'המסך הזה נקרא "דף חשבון עתידי", וכאן מנהלים הוצאות והכנסות שכבר יודעים עליהן מראש - הוראת קבע, תשלומים, מנוי חודשי, ועוד.\n\nהתוכנה מנחה אותך: "כרטיסיית פעולה - בחר שורה או התחל חדש".\n\nלכל פריט שמוסיפים יש כרטיסייה משלו, עם השדות הבאים:\n\n•    מקור\n•    סיווג\n•    הערה\n•    תיאור\n•    בנק\n•    חשבון\n•    הכנסה או הוצאה\n•    תאריך התחלה\n•    מספר תשלומים\n\nברגע שקובעים תאריך התחלה ומספר תשלומים, התוכנה כבר דואגת לפרוס את הסכום קדימה על פני כל אותם החודשים, ומשלבת אותו אוטומטית בכל שאר המסכים (כשהמתג "כולל עתידי" פעיל).\n\nהפעולות הזמינות לך: עדכון, חדש, עריכה, איפוס, מחיקה.' },
    { heading: 'מסך הגרפים', body: 'המסך הזה נקרא "דף חשבון בתצוגה גרפית", והוא נותן לך את אותם הנתונים - אבל בתמונה, לא בטבלה.\n\nאפשר לבחור בין כמה מצבי תצוגה: מאזן, יתרה, הוצאות, וכן תצוגה ממוקדת לפי סיווג, פריט בודד, תכנון עתידי, או כרטיסי אשראי.' },
    { heading: 'עוגת התקציב', body: 'בתוך מסך הגרפים תמצאו כלי מיוחד בשם "עוגת התקציב", שמטרתו "תכנון מאזן תקציב בית" - זהו כלי לוויסות חי של התקציב שלך: בוחרים תקופה להצגה (שנה וחודש), ויכולים לגרור ולשנות את החלוקה בין הקטגוריות ולראות מיד איך זה משפיע על האיזון הכללי של התקציב.\n\nהכפתורים הזמינים: עדכן, אפס, רענן.' },
...
const SITE_GUIDE_SECTIONS: Record<string, GuideSection[]> = {
  he: [
    ...
    { heading: 'דף הבית KeyClick', body: 'לחצת? זהו, אתם באתר. גליל עם ברכת כניסה ודגל השפה מתגלים לפניך.\nהשפה לא מתאימה ? בחרו 1 מתוך 11 הדגלים בראש האתר ותועבר מידית לשפה הנבחרת. מערכת ריבוי השפות הוא אחד מיחידות הבסיס של האתר ומוצריו. ניתן בכל עת לעבור מידית משפה לשפה.' },
    ...
    { heading: 'שימוש חופשי ללא הרשמה', body: 'בכניסה לאתר, טרם הרישום ניתן לפתוח את מדריכים וסרטונים ולקבל מושג והנחיות איך להפיק מהמערכת את המיטב.\nעברת על המדריכים והסרטונים וברצונך להתחיל להנות מניהול תקציב בית חכם, לחצו על כפתור הכניסה ובצעו רישום מהיר.' },
    { heading: 'כניסה ורישום', body: 'לקוח רשום - אם אתם כבר רשומים במערכת, הכניסו שם ומשפחה, כתובת מייל, סיסמא.\nבמידה ומתגלות שגיאות או חוסר התאמה בפרטים שהזנת, תתקבל הודעה: לקוח לא קיים.\nלקוח חדש – לחצו על כניסה ובחרו הרשמה.\nכעת מתחיל תהליך קצר של רישום ובחירת תכנית מותאמת אישית.\nבשלב של תקופת הרצה ותקופת ניסיון, השימוש הוא חינם ללא עלות. בתום תקופת ההרצה תצא הודעה מתאימה ללקוחות.' },
    { heading: 'חבילות שימוש במערכת', body: 'בתום תקופת ההרצה או תקופת הניסיון , קיבלת על כך הודעת מערכת, גמרת תקופת השימוש החינמי ומגיע הזמן לבחור תכנית חבילת שימוש. לחצו על תווית דף אישי, לחצו על תווית השינוי וייפתח טופס שינוי תכנית.\nקיימות 3 תכניות ממומנות: מנוי שנתי, מנוי חודשי, מנוי לפי שימוש.' },
